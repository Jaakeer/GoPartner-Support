!function(e, t) {
    ...
    function i(e, n, r, i) {
        if (se.acceptData(e)) {
            var o, a, s = se.expando, u = "string" == typeof n, l = e.nodeType, c = l ? se.cache : e, f = l ? e[s] : e[s] && s;
            if (f && c[f] && (i || c[f].data) || !u || r !== t)
                return f || (l ? e[s] = f = Z.pop() || se.guid++ : f = s),
                c[f] || (c[f] = {},
                ...
                u ? null == (a = o[n]) && (a = o[se.camelCase(n)]) : a = o,
                a
        }
    }
    function o(e, t, n) {
        if (se.acceptData(e)) {
            ...
            if (u[l]) {
                if (t && (o = n ? u[l] : u[l].data)) {
                    se.isArray(t) ? t = t.concat(se.map(t, se.camelCase)) : t in o ? t = [t] : (t = se.camelCase(t),
                    t = t in o ? [t] : t.split(" "));
                    for (r = 0,
                    i = t.length; r < i; r++)
                        delete o[t[r]];
                    if (!(n ? s : se.isEmptyObject)(o))
                        return
                }
                (n || (delete u[l].data,
                s(u[l]))) && (a ? se.cleanData([e], !0) : se.support.deleteExpando || u != u.window ? delete u[l] : u[l] = null)
            }
        }
    }
    function a(e, n, r) {
    ...
    function m(e, t) {
        for (var n, r = 0; null != (n = e[r]); r++)
            se._data(n, "globalEval", !t || se._data(t[r], "globalEval"))
    }
    function y(e, t) {
    ...
    function v(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            !se.support.noCloneEvent && t[se.expando]) {
                i = se._data(t);
                for (r in i.events)
                    se.removeEvent(t, r, i.handle);
                t.removeAttribute(se.expando)
            }
            "script" === n && t.text !== e.text ? (h(t).text = e.text,
            g(t)) : "object" === n ? (t.parentNode && (t.outerHTML = e.outerHTML),
            se.support.html5Clone && e.innerHTML && !se.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && et.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function b(e, n) {
        ...
        if (!a)
            ...
            r = e.childNodes || e; null != (i = r[o]); o++)
                !n || se.nodeName(i, n) ? a.push(i) : se.merge(a, b(i, n));
    ...
    function N(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
            r = e[a],
            r.style && (o[a] = se._data(r, "olddisplay"),
            n = r.style.display,
            t ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display && T(r) && (o[a] = se._data(r, "olddisplay", S(r.nodeName)))) : o[a] || (i = T(r),
            (n && "none" !== n || !i) && se._data(r, "olddisplay", i ? n : se.css(r, "display"))));
        for (a = 0; a < s; a++)
            r = e[a],
    ...
    function k(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)
            "margin" === n && (a += se.css(e, n + Tt[o], !0, i)),
            r ? ("content" === n && (a -= se.css(e, "padding" + Tt[o], !0, i)),
            "margin" !== n && (a -= se.css(e, "border" + Tt[o] + "Width", !0, i))) : (a += se.css(e, "padding" + Tt[o], !0, i),
            "padding" !== n && (a += se.css(e, "border" + Tt[o] + "Width", !0, i)));
        return a
    }
    function E(e, t, n) {
        var r = !0
    ...
    function S(e) {
        var t = Y
          , n = bt[e];
        return n || (n = A(e, t),
        "none" !== n && n || (ut = (ut || se("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement),
    ...
    function j(e, t, n, r) {
        ...
        if (se.isArray(t))
            se.each(t, function(t, i) {
                n || kt.test(e) ? r(e, i) : j(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
            });
    ...
    function B(e, t) {
        se.each(t, function(t, n) {
            for (var r = (nn[t] || []).concat(nn["*"]), i = 0, o = r.length; i < o; i++)
                if (r[i].call(e, t, n))
                    return
        })
    }
    function P(e, t, n) {
        var r, i, o = 0, a = tn.length, s = se.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (i)
                return !1;
            for (var t = Gt || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; a < u; a++)
                l.tweens[a].run(o);
    ...
    function W(e, t, n) {
        ...
        "inline" === se.css(e, "display") && "none" === se.css(e, "float") && (se.support.inlineBlockNeedsLayout && "inline" !== S(e.nodeName) ? d.zoom = 1 : d.display = "inline-block")),
        n.overflow && (d.overflow = "hidden",
        se.support.shrinkWrapBlocks || p.always(function() {
    ...
    var X, U, V = typeof t, Y = e.document, J = e.location, G = e.jQuery, Q = e.$, K = {}, Z = [], ee = Z.concat, te = Z.push, ne = Z.slice, re = Z.indexOf, ie = K.toString, oe = K.hasOwnProperty, ae = "1.9.1".trim, se = function(e, t) {
        return new se.fn.init(e,t,U)
    }, ue = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, le = /\S+/g, ce = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, fe = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, pe = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, de = /^[\],:{}\s]*$/, he = /(?:^|:|,)(?:\s*\[)+/g, ge = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, me = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, ye = /^-ms-/, ve = /-([\da-z])/gi, be = function(e, t) {
        return t.toUpperCase()
    }, xe = function(e) {
        (Y.addEventListener || "load" === e.type || "complete" === Y.readyState) && (we(),
        se.ready())
    }, we = function() {
    ...
    se.fn = se.prototype = {
        ...
        init: function(e, n, r) {
            ...
            if (!e)
                return this;
            if ("string" == typeof e) {
                if (!(i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : fe.exec(e)) || !i[1] && n)
                    return !n || n.jquery ? (n || r).find(e) : this.constructor(n).find(e);
                if (i[1]) {
                    if (n = n instanceof se ? n[0] : n,
                    se.merge(this, se.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : Y, !0)),
                    pe.test(i[1]) && se.isPlainObject(n))
                        for (i in n)
                            se.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
                    return this
                }
            ...
            this.length = 1,
            this) : se.isFunction(e) ? r.ready(e) : (e.selector !== t && (this.selector = e.selector,
        ...
        --u); u < l; u++)
            if (null != (o = arguments[u]))
                for (i in o)
                    e = s[i],
                    r = o[i],
                    s !== r && (c && r && (se.isPlainObject(r) || (n = se.isArray(r))) ? (n ? (n = !1,
                    a = e && se.isArray(e) ? e : []) : a = e && se.isPlainObject(e) ? e : {},
                    s[i] = se.extend(c, a, r)) : r !== t && (s[i] = r));
        return s
    }
    ,
    se.extend({
        ...
        ready: function(e) {
            if (!0 === e ? !--se.readyWait : !se.isReady) {
                ...
                se.isReady = !0,
                !0 !== e && --se.readyWait > 0 || (X.resolveWith(Y, [se]),
                se.fn.trigger && se(Y).trigger("ready").off("ready"))
            }
        },
        ...
        type: function(e) {
            return null == e ? String(e) : "object" == typeof e || "function" == typeof e ? K[ie.call(e)] || "object" : typeof e
        },
        ...
        parseHTML: function(e, t, n) {
            ...
            var r = pe.exec(e)
              , i = !n && [];
            return r ? [t.createElement(r[1])] : (r = se.buildFragment([e], t, i),
            i && se(i).remove(),
            se.merge([], r.childNodes))
        },
        parseJSON: function(t) {
            return e.JSON && e.JSON.parse ? e.JSON.parse(t) : null === t ? t : "string" == typeof t && (t = se.trim(t)) && de.test(t.replace(ge, "@").replace(me, "]").replace(he, "")) ? new Function("return " + t)() : void se.error("Invalid JSON: " + t)
        },
        parseXML: function(n) {
            var r, i;
        ...
        proxy: function(e, n) {
            ...
            n = e,
            e = o),
            se.isFunction(e) ? (r = ne.call(arguments, 2),
            i = function() {
    ...
    se.Callbacks = function(e) {
        e = "string" == typeof e ? Te[e] || r(e) : se.extend({}, e);
        var n, i, o, a, s, u, l = [], c = !e.once && [], f = function(t) {
            ...
            remove: function() {
                return l && se.each(arguments, function(e, t) {
                    for (var r; (r = se.inArray(t, l, r)) > -1; )
                        l.splice(r, 1),
                        n && (r <= a && a--,
                        r <= s && s--)
                }),
    ...
    se.extend({
        ...
        when: function(e) {
            var t, n, r, i = 0, o = ne.call(arguments), a = o.length, s = 1 !== a || e && se.isFunction(e.promise) ? a : 0, u = 1 === s ? e : se.Deferred(), l = function(e, n, r) {
                return function(i) {
                    n[e] = this,
            ...
            if (a > 1)
                ...
                n = new Array(a),
                r = new Array(a); i < a; i++)
                    o[i] && se.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --s;
    ...
    se.support = function() {
        ...
        for (c in {
            ...
            t[c + "Bubbles"] = u in e || !1 === f.attributes[u].expando;
        ...
        se(function() {
            ...
            typeof f.style.zoom !== V && (f.innerHTML = "",
    ...
    se.fn.extend({
        data: function(e, n) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                if (n === t)
                    return o ? a(o, e, se.data(o, e)) : null;
                this.each(function() {
                    se.data(this, e, n)
                })
    ...
    se.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                r = se._data(e, t),
                n && (!r || se.isArray(n) ? r = se._data(e, t, se.makeArray(n)) : r.push(n)),
                r || []
        },
    ...
    se.fn.extend({
        ...
        promise: function(e, n) {
            ...
            e = t),
            e = e || "fx"; s--; )
                (r = se._data(a[s], e + "queueHooks")) && r.empty && (i++,
                r.empty.add(u));
            return u(),
            o.promise(n)
        }
    });
    var ke, Ee, Se = /[\t\r\n]/g, Ae = /\r/g, je = /^(?:input|select|textarea|button|object)$/i, De = /^(?:a|area)$/i, Le = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, He = /^(?:checked|selected)$/i, qe = se.support.getSetAttribute, Me = se.support.input;
    se.fn.extend({
        attr: function(e, t) {
        ...
        addClass: function(e) {
            ...
            if (u)
                for (t = (e || "").match(le) || []; a < s; a++)
                    if (n = this[a],
                    r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Se, " ") : " ")) {
                        for (o = 0; i = t[o++]; )
                            r.indexOf(" " + i + " ") < 0 && (r += i + " ");
        ...
        toggleClass: function(e, t) {
            ...
            return se.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var i, o = 0, a = se(this), s = t, u = e.match(le) || []; i = u[o++]; )
                        s = r ? s : !a.hasClass(i),
                        a[s ? "addClass" : "removeClass"](i);
                else
                    n !== V && "boolean" !== n || (this.className && se._data(this, "__className__", this.className),
                    this.className = this.className || !1 === e ? "" : se._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
                if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(Se, " ").indexOf(t) >= 0)
                    return !0;
            return !1
        },
        val: function(e) {
            ...
            {
                if (arguments.length)
                    return i = se.isFunction(e),
                    this.each(function(n) {
                        var o, a = se(this);
                        1 === this.nodeType && (o = i ? e.call(this, n, a.val()) : e,
                        null == o ? o = "" : "number" == typeof o ? o += "" : se.isArray(o) && (o = se.map(o, function(e) {
                            return null == e ? "" : e + ""
                        })),
                        (r = se.valHooks[this.type] || se.valHooks[this.nodeName.toLowerCase()]) && "set"in r && r.set(this, o, "value") !== t || (this.value = o))
                    });
                if (o)
                    return (r = se.valHooks[o.type] || se.valHooks[o.nodeName.toLowerCase()]) && "get"in r && (n = r.get(o, "value")) !== t ? n : (n = o.value,
    ...
    se.extend({
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, u = i < 0 ? s : o ? i : 0; u < s; u++)
                        if (n = r[u],
                        (n.selected || u === i) && (se.support.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !se.nodeName(n.parentNode, "optgroup"))) {
                            if (t = se(n).val(),
                            o)
                                return t;
                            a.push(t)
        ...
        attr: function(e, n, r) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s)
                return typeof e.getAttribute === V ? se.prop(e, n, r) : (o = 1 !== s || !se.isXMLDoc(e),
                o && (n = n.toLowerCase(),
                i = se.attrHooks[n] || (Le.test(n) ? Ee : ke)),
                r === t ? i && o && "get"in i && null !== (a = i.get(e, n)) ? a : (typeof e.getAttribute !== V && (a = e.getAttribute(n)),
                null == a ? t : a) : null !== r ? i && o && "set"in i && (a = i.set(e, r, n)) !== t ? a : (e.setAttribute(n, r + ""),
                r) : void se.removeAttr(e, n))
        },
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++]; )
                    r = se.propFix[n] || n,
                    Le.test(n) ? !qe && He.test(n) ? e[se.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : se.attr(e, n, ""),
                    e.removeAttribute(qe ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    Ee = {
        ...
        set: function(e, t, n) {
            return !1 === t ? se.removeAttr(e, n) : Me && qe || !He.test(n) ? e.setAttribute(!qe && se.propFix[n] || n, n) : e[se.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    Me && qe || (se.attrHooks.value = {
        ...
        set: function(e, t, n) {
            if (!se.nodeName(e, "input"))
                return ke && ke.set(e, t, n);
            e.defaultValue = t
        }
    }),
    ...
    se.support.checkOn || se.each(["radio", "checkbox"], function() {
        se.valHooks[this] = {
            get: function(e) {
    ...
    se.each(["radio", "checkbox"], function() {
        se.valHooks[this] = se.extend(se.valHooks[this], {
            set: function(e, t) {
                if (se.isArray(t))
                    return e.checked = se.inArray(se(e).val(), t) >= 0
            }
        })
    });
    ...
    se.event = {
        ...
        add: function(e, n, r, i, o) {
            ...
            if (y) {
                ...
                (f = y.handle) || (f = y.handle = function(e) {
                    return typeof se === V || e && se.event.triggered === e.type ? t : se.event.dispatch.apply(f.elem, arguments)
                }
                ,
                f.elem = e),
                n = (n || "").match(le) || [""],
                u = n.length; u--; )
                    ...
                    (d = s[h]) || (d = s[h] = [],
                    d.delegateCount = 0,
                    c.setup && !1 !== c.setup.call(e, i, g, f) || (e.addEventListener ? e.addEventListener(h, f, !1) : e.attachEvent && e.attachEvent("on" + h, f))),
            ...
            if (m && (c = m.events)) {
                ...
                l = t.length; l--; )
                    ...
                    d) {
                        ...
                        u && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || se.removeEvent(e, d, m.handle),
                        delete c[d])
                    } else
                        for (d in c)
                            se.event.remove(e, d + t[l], n, r, !0);
                se.isEmptyObject(c) && (delete m.handle,
                se._removeData(e, "events"))
            }
        },
        trigger: function(n, r, i, o) {
            var a, s, u, l, c, f, p, d = [i || Y], h = oe.call(n, "type") ? n.type : n, g = oe.call(n, "namespace") ? n.namespace.split(".") : [];
            if (u = f = i = i || Y,
            3 !== i.nodeType && 8 !== i.nodeType && !Be.test(h + se.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."),
            h = g.shift(),
            g.sort()),
            s = h.indexOf(":") < 0 && "on" + h,
            n = n[se.expando] ? n : new se.Event(h,"object" == typeof n && n),
            n.isTrigger = !0,
            n.namespace = g.join("."),
            n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
            n.result = t,
            n.target || (n.target = i),
            r = null == r ? [n] : se.makeArray(r, [n]),
            c = se.event.special[h] || {},
            o || !c.trigger || !1 !== c.trigger.apply(i, r))) {
                if (!o && !c.noBubble && !se.isWindow(i)) {
                    for (l = c.delegateType || h,
                    Be.test(l + h) || (u = u.parentNode); u; u = u.parentNode)
                        d.push(u),
                        f = u;
                ...
                for (p = 0; (u = d[p++]) && !n.isPropagationStopped(); )
                    ...
                    a = (se._data(u, "events") || {})[n.type] && se._data(u, "handle"),
                    a && a.apply(u, r),
                    (a = s && u[s]) && se.acceptData(u) && a.apply && !1 === a.apply(u, r) && n.preventDefault();
                if (n.type = h,
                !o && !n.isDefaultPrevented() && (!c._default || !1 === c._default.apply(i.ownerDocument, r)) && ("click" !== h || !se.nodeName(i, "a")) && se.acceptData(i) && s && i[h] && !se.isWindow(i)) {
                    f = i[s],
                    f && (i[s] = null),
        ...
        dispatch: function(e) {
            e = se.event.fix(e);
            var n, r, i, o, a, s = [], u = ne.call(arguments), l = (se._data(this, "events") || {})[e.type] || [], c = se.event.special[e.type] || {};
            if (u[0] = e,
            e.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                for (s = se.event.handlers.call(this, e, l),
                n = 0; (o = s[n++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = o.elem,
                    a = 0; (i = o.handlers[a++]) && !e.isImmediatePropagationStopped(); )
                        e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i,
                        e.data = i.data,
                        (r = ((se.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u)) !== t && !1 === (e.result = r) && (e.preventDefault(),
                        e.stopPropagation()));
                ...
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                        ...
                        a = 0; a < u; a++)
                            i = n[a],
                            r = i.selector + " ",
                            o[r] === t && (o[r] = i.needsContext ? se(r, this).index(l) >= 0 : se.find(r, this, null, [l]).length),
                            o[r] && o.push(i);
                        o.length && s.push({
                            elem: l,
                            handlers: o
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[i] = a = Oe.test(i) ? this.mouseHooks : Fe.test(i) ? this.keyHooks : {}),
    ...
    se.removeEvent = Y.removeEventListener ? function(e, t, n) {
        e.removeEventListener && e.removeEventListener(t, n, !1)
    }
    : function(e, t, n) {
        var r = "on" + t;
        e.detachEvent && (typeof e[r] === V && (e[r] = null),
        e.detachEvent(r, n))
    }
    ,
    se.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? u : l) : this.type = e,
        t && se.extend(this, t),
    ...
    se.support.submitBubbles || (se.event.special.submit = {
        ...
        postDispatch: function(e) {
            ...
            this.parentNode && !e.isTrigger && se.event.simulate("submit", this.parentNode, e, !0))
        },
        teardown: function() {
            if (se.nodeName(this, "form"))
                return !1;
    ...
    se.support.changeBubbles || (se.event.special.change = {
        setup: function() {
            if (_e.test(this.nodeName))
                return "checkbox" !== this.type && "radio" !== this.type || (se.event.add(this, "propertychange._change", function(e) {
    ...
    function(e, t) {
        ...
        function a(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : B) !== j && A(t),
            t = t || j,
            n = n || [],
            !e || "string" != typeof e)
                return n;
            ...
            if (!L && !r) {
                if (i = fe.exec(e))
                    if (a = i[1]) {
                        ...
                        if (i[2])
                            return Y.apply(n, J.call(t.getElementsByTagName(e), 0)),
                            n;
                        if ((a = i[3]) && P.getByClassName && t.getElementsByClassName)
                            return Y.apply(n, J.call(t.getElementsByClassName(a), 0)),
                            n
                    }
                if (P.qsa && !H.test(e)) {
                    if (p = !0,
                    ...
                    1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (f = l(e),
                        (p = t.getAttribute("id")) ? d = p.replace(he, "\\$&") : t.setAttribute("id", d),
                        d = "[id='" + d + "'] ",
                        u = f.length; u--; )
                            f[u] = d + c(f[u]);
                        h = le.test(e) && t.parentNode || t,
                        g = f.join(",")
                    }
                    if (g)
                        try {
                            return Y.apply(n, J.call(h.querySelectorAll(g), 0)),
                            n
                        } catch (e) {} finally {
        ...
        function l(e, t) {
            ...
            u = [],
            l = T.preFilter; s; ) {
                n && !(r = re.exec(s)) || (r && (s = s.slice(r[0].length) || s),
                u.push(i = [])),
                n = !1,
                (r = ie.exec(s)) && (n = r.shift(),
                i.push({
                    value: n,
                    type: r[0].replace(ne, " ")
                }),
                s = s.slice(n.length));
                for (o in T.filter)
                    !(r = ue[o].exec(s)) || l[o] && !(r = l[o](r)) || (n = r.shift(),
                    i.push({
                        value: n,
                        type: o,
                        matches: r
        ...
        function h(e, t, n, r, o, a) {
            ...
            o && !o[O] && (o = h(o, a)),
            i(function(i, a, s, u) {
                var l, c, f, p = [], h = [], g = a.length, m = i || y(t || "*", s.nodeType ? [s] : s, []), v = !e || !i && t ? m : d(m, p, e, s, u), b = n ? o || (i ? e : g || r) ? [] : a : v;
                if (n && n(v, b, s, u),
                r)
                    for (l = d(b, h),
                    r(l, [], s, u),
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (c = b.length; c--; )
                            (f = b[c]) && (l = o ? G.call(i, f) : p[c]) > -1 && (i[l] = !(a[l] = f))
                    }
                } else
                    b = d(b === a ? b.splice(g, b.length) : b),
                    o ? o(null, a, b, u) : Y.apply(a, b)
            })
        }
        function g(e) {
        ...
        function m(e, t) {
            var n = 0
              ...
              , s = function(i, s, u, l, c) {
                var f, p, h, g = [], m = 0, y = "0", v = i && [], b = null != c, x = S, N = i || o && T.find.TAG("*", c && s.parentNode || s), C = R += null == x ? 1 : Math.random() || .1;
                for (b && (S = s !== j && s,
                w = n); null != (f = N[y]); y++) {
                    if (o && f) {
                        for (p = 0; h = e[p++]; )
        ...
        function v(e, t, n, r) {
            ...
            if (!r && 1 === f.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && !L && T.relative[o[1].type]) {
                    if (!(t = T.find.ID(a.matches[0].replace(me, ye), t)[0]))
                        return n;
                    e = e.slice(o.shift().value.length)
                }
                for (i = ue.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i],
                !T.relative[s = a.type]); )
                    if ((u = T.find[s]) && (r = u(a.matches[0].replace(me, ye), le.test(o[0].type) && t.parentNode || t))) {
                        if (o.splice(i, 1),
                        !(e = r.length && c(o)))
                            return Y.apply(n, J.call(r, 0)),
                            n;
                        break
                    }
            }
            return k(e, f)(r, t, L, n, le.test(e)),
            n
        }
        function b() {}
        var x, w, T, N, C, k, E, S, A, j, D, L, H, q, M, _, F, O = "sizzle" + -new Date, B = e.document, P = {}, R = 0, W = 0, $ = r(), I = r(), z = r(), X = 1 << 31, U = [], V = U.pop, Y = U.push, J = U.slice, G = U.indexOf || function(e) {
            for (var t = 0, n = this.length; t < n; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , Q = "[\\x20\\t\\r\\n\\f]", K = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", Z = K.replace("w", "w#"), ee = "\\[" + Q + "*(" + K + ")" + Q + "*(?:([*^$|!~]?=)" + Q + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + Z + ")|)|)" + Q + "*\\]", te = ":(" + K + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + ee.replace(3, 8) + ")*)|.*)\\)|)", ne = new RegExp("^" + Q + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Q + "+$","g"), re = new RegExp("^" + Q + "*," + Q + "*"), ie = new RegExp("^" + Q + "*([\\x20\\t\\r\\n\\f>+~])" + Q + "*"), oe = new RegExp(te), ae = new RegExp("^" + Z + "$"), ue = {
            ID: new RegExp("^#(" + K + ")"),
            CLASS: new RegExp("^\\.(" + K + ")"),
        ...
        A = a.setDocument = function(e) {
            ...
            return t !== j && 9 === t.nodeType && t.documentElement ? (j = t,
            D = t.documentElement,
            L = C(t),
            ...
            P.getByName = o(function(e) {
                ...
                return P.getIdNotName = !t.getElementById(O),
                D.removeChild(e),
                n
            }),
            ...
            q = [],
            H = [":focus"],
            (P.qsa = n(t.querySelectorAll)) && (o(function(e) {
                e.innerHTML = "<select><option selected=''></option></select>",
                e.querySelectorAll("[selected]").length || H.push("\\[" + Q + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                e.querySelectorAll(":checked").length || H.push(":checked")
            }),
            o(function(e) {
                e.innerHTML = "<input type='hidden' i=''/>",
                e.querySelectorAll("[i^='']").length && H.push("[*^$]=" + Q + "*(?:\"\"|'')"),
            ...
            H = new RegExp(H.join("|")),
            q = new RegExp(q.join("|")),
            _ = n(D.contains) || D.compareDocumentPosition ? function(e, t) {
            ...
            F = D.compareDocumentPosition ? function(e, n) {
                var r;
                return e === n ? (E = !0,
                0) : (r = n.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(n)) ? 1 & r || e.parentNode && 11 === e.parentNode.nodeType ? e === t || _(B, e) ? -1 : n === t || _(B, n) ? 1 : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
            }
            : function(e, n) {
        ...
        a.matchesSelector = function(e, t) {
            ...
            t = t.replace(ge, "='$1']"),
            P.matchesSelector && !L && (!q || !q.test(t)) && !H.test(t))
                try {
                    var n = M.call(e, t);
        ...
        a.attr = function(e, t) {
            ...
            return (e.ownerDocument || e) !== j && A(e),
            L || (t = t.toLowerCase()),
            (n = T.attrHandle[t]) ? n(e) : L || P.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && !0 === e[t] ? t : n && n.specified ? n.value : null
        }
        ,
        a.error = function(e) {
        ...
        T = a.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[5] && e[2];
                    return ue.CHILD.test(e[0]) ? null : (e[4] ? e[2] = e[4] : n && oe.test(n) && (t = l(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        ...
                        if (m) {
                            ...
                            } else if (v && (l = (t[O] || (t[O] = {}))[e]) && l[0] === R)
                                p = l[1];
                            else
                                for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[O] || (f[O] = {}))[e] = [R, p]),
                                f !== t)); )
                                    ;
                ...
                PSEUDO: function(e, t) {
                    ...
                    return r[O] ? r(t) : r.length > 1 ? (n = [e, e, "", t],
            ...
            pseudos: {
                ...
                lang: i(function(e) {
                    return ae.test(e || "") || a.error("unsupported lang: " + e),
                    e = e.replace(me, ye).toLowerCase(),
                    function(t) {
                        var n;
                        do {
        ...
        T.filters = b.prototype = T.pseudos,
        T.setFilters = new b,
        A(),
        a.attr = se.attr,
        se.find = a,
    ...
    se.fn.extend({
        find: function(e) {
            ...
            if ("string" != typeof e)
                ...
                this.pushStack(se(e).filter(function() {
                    for (t = 0; t < i; t++)
                        if (se.contains(r[t], this))
                            return !0
                }));
            for (n = [],
            t = 0; t < i; t++)
                se.find(e, this[t], n);
            return n = this.pushStack(i > 1 ? se.unique(n) : n),
        ...
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = Ie.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; r < i; r++)
    ...
    se.each({
        ...
        se.fn[e] = function(n, r) {
            ...
            i = this.length > 1 && !ze[e] ? se.unique(i) : i,
            this.length > 1 && We.test(e) && (i = i.reverse()),
            this.pushStack(i)
        }
    }),
    se.extend({
        ...
        dir: function(e, n, r) {
            for (var i = [], o = e[n]; o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !se(o).is(r)); )
    ...
    var Xe = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video"
      ...
      , at = p(Y)
      , st = at.appendChild(Y.createElement("div"));
    ...
    se.fn.extend({
        text: function(e) {
            return se.access(this, function(e) {
                return e === t ? se.text(this) : this.empty().append((this[0] && this[0].ownerDocument || Y).createTextNode(e))
        ...
        remove: function(e, t) {
            for (var n, r = 0; null != (n = this[r]); r++)
                (!e || se.filter(e, [n]).length > 0) && (t || 1 !== n.nodeType || se.cleanData(b(n)),
                n.parentNode && (t && se.contains(n.ownerDocument, n) && m(b(n, "script")),
                n.parentNode.removeChild(n)));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && se.cleanData(b(e, !1)); e.firstChild; )
        ...
        html: function(e) {
            return se.access(this, function(e) {
                var n = this[0] || {}
                  ...
                  , i = this.length;
                if (e === t)
                    return 1 === n.nodeType ? n.innerHTML.replace(Ue, "") : t;
                if ("string" == typeof e && !Ze.test(e) && (se.support.htmlSerialize || !Ve.test(e)) && (se.support.leadingWhitespace || !Ye.test(e)) && !ot[(Ge.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; r < i; r++)
                            n = this[r] || {},
                            1 === n.nodeType && (se.cleanData(b(n, !1)),
                            n.innerHTML = e);
                        n = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, n, r) {
            ...
            if (v || !(f <= 1 || "string" != typeof y || se.support.checkClone) && tt.test(y))
                return this.each(function(i) {
                    var o = p.eq(i);
                    v && (e[0] = y.call(this, i, n ? o.html() : t)),
                    o.domManip(e, n, r)
                });
            if (f && (l = se.buildFragment(e, this[0].ownerDocument, !1, this),
            i = l.firstChild,
            1 === l.childNodes.length && (l = i),
            i)) {
                for (n = n && se.nodeName(i, "tr"),
                s = se.map(b(l, "script"), h),
                a = s.length; c < f; c++)
                    o = l,
                    c !== m && (o = se.clone(o, !0, !0),
                    a && se.merge(s, b(o, "script"))),
                    r.call(n && se.nodeName(this[c], "table") ? d(this[c], "tbody") : this[c], o, c);
                if (a)
                    for (u = s[s.length - 1].ownerDocument,
                    se.map(s, g),
                    c = 0; c < a; c++)
                        o = s[c],
                        nt.test(o.type || "") && !se._data(o, "globalEval") && se.contains(u, o) && (o.src ? se.ajax({
                            url: o.src,
                            type: "GET",
                            dataType: "script",
                            async: !1,
    ...
    se.each({
        ...
        se.fn[e] = function(e) {
            for (var n, r = 0, i = [], o = se(e), a = o.length - 1; r <= a; r++)
    ...
    se.extend({
        clone: function(e, t, n) {
            ...
            if (se.support.html5Clone || se.isXMLDoc(e) || !Ve.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (st.innerHTML = e.outerHTML,
            st.removeChild(o = st.firstChild)),
            !(se.support.noCloneEvent && se.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e)))
                for (r = b(o),
                s = b(e),
                a = 0; null != (i = s[a]); ++a)
                    r[a] && v(i, r[a]);
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, d = p(t), h = [], g = 0; g < f; g++)
                if ((o = e[g]) || 0 === o)
                    if ("object" === se.type(o))
                        ...
                        c = ot[u] || ot._default,
                        s.innerHTML = c[1] + o.replace(Je, "<$1></$2>") + c[2],
                        i = c[0]; i--; )
                            s = s.lastChild;
                        if (!se.support.leadingWhitespace && Ye.test(o) && h.push(t.createTextNode(Ye.exec(o)[0])),
                        !se.support.tbody)
                            for (o = "table" !== u || Qe.test(o) ? "<table>" !== c[1] || Qe.test(o) ? 0 : s : s.firstChild,
                            i = o && o.childNodes.length; i--; )
                                se.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
                        for (se.merge(h, s.childNodes),
            ...
            se.support.appendChecked || se.grep(b(h, "input"), x),
            g = 0; o = h[g++]; )
                if ((!r || -1 === se.inArray(o, r)) && (a = se.contains(o.ownerDocument, o),
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, s = se.expando, u = se.cache, l = se.support.deleteExpando, c = se.event.special; null != (n = e[a]); a++)
                if ((t || se.acceptData(n)) && (i = n[s],
                o = i && u[i])) {
                    if (o.events)
                        for (r in o.events)
                            c[r] ? se.event.remove(n, r) : se.removeEvent(n, r, o.handle);
                    u[i] && (delete u[i],
                    l ? delete n[s] : typeof n.removeAttribute !== V ? n.removeAttribute(s) : n[s] = null,
                    Z.push(i))
                }
        }
    });
    var ut, lt, ct, ft = /alpha\([^)]*\)/i, pt = /opacity\s*=\s*([^)]*)/, dt = /^(top|right|bottom|left)$/, ht = /^(none|table(?!-c[ea]).+)/, gt = /^margin/, mt = new RegExp("^(" + ue + ")(.*)$","i"), yt = new RegExp("^(" + ue + ")(?!px)[a-z%]+$","i"), vt = new RegExp("^([+-])=(" + ue + ")","i"), bt = {
        BODY: "block"
    }, xt = {
        position: "absolute",
        visibility: "hidden",
        ...
        letterSpacing: 0,
        fontWeight: 400
    }, Tt = ["Top", "Right", "Bottom", "Left"], Nt = ["Webkit", "O", "Moz", "ms"];
    se.fn.extend({
        css: function(e, n) {
        ...
        toggle: function(e) {
            ...
            return this.each(function() {
                (t ? e : T(this)) ? se(this).show() : se(this).hide()
            })
        }
    }),
    se.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = se.cssProps[u] || (se.cssProps[u] = w(l, u)),
                s = se.cssHooks[n] || se.cssHooks[u],
                r === t)
                    return s && "get"in s && (o = s.get(e, !1, i)) !== t ? o : l[n];
                if (!(a = typeof r,
                "string" === a && (o = vt.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(se.css(e, n)),
                a = "number"),
                null == r || "number" === a && isNaN(r) || ("number" !== a || se.cssNumber[u] || (r += "px"),
                se.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (l[n] = "inherit"),
    ...
    ,
    ct = function(e, n, r) {
        var i, o, a, s = r || lt(e), u = s ? s.getPropertyValue(n) || s[n] : t, l = e.style;
        return s && ("" !== u || se.contains(e.ownerDocument, e) || (u = se.style(e, n)),
        yt.test(u) && gt.test(n) && (i = l.width,
        o = l.minWidth,
        a = l.maxWidth,
    ...
    ,
    ct = function(e, n, r) {
        var i, o, a, s = r || lt(e), u = s ? s[n] : t, l = e.style;
        return null == u && l && l[n] && (u = l[n]),
        yt.test(u) && !dt.test(n) && (i = l.left,
        o = e.runtimeStyle,
        a = o && o.left,
    ...
    se.each(["height", "width"], function(e, t) {
        se.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return 0 === e.offsetWidth && ht.test(se.css(e, "display")) ? se.swap(e, xt, function() {
                        return E(e, t, r)
                    }) : E(e, t, r)
            },
            set: function(e, n, r) {
    ...
    se.support.opacity || (se.cssHooks.opacity = {
        ...
        set: function(e, t) {
            ...
            n.zoom = 1,
            (t >= 1 || "" === t) && "" === se.trim(o.replace(ft, "")) && n.removeAttribute && (n.removeAttribute("filter"),
    ...
    se(function() {
        ...
        !se.support.pixelPosition && se.fn.position && se.each(["top", "left"], function(e, t) {
            se.cssHooks[t] = {
                get: function(e, n) {
                    if (n)
                        return n = ct(e, t),
                        yt.test(n) ? se(e).position()[t] + "px" : n
                }
            }
        })
    }),
    se.expr && se.expr.filters && (se.expr.filters.hidden = function(e) {
        return e.offsetWidth <= 0 && e.offsetHeight <= 0 || !se.support.reliableHiddenOffsets && "none" === (e.style && e.style.display || se.css(e, "display"))
    }
    ,
    ...
    se.each({
        ...
        gt.test(e) || (se.cssHooks[e + t].set = C)
    });
    var Ct = /%20/g
      , kt = /\[\]$/
      , Et = /\r?\n/g
    ...
    se.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !se(this).is(":disabled") && At.test(this.nodeName) && !St.test(e) && (this.checked || !et.test(e))
            }).map(function(e, t) {
                var n = se(this).val();
    ...
    se.param = function(e, n) {
        ...
        if (n === t && (n = se.ajaxSettings && se.ajaxSettings.traditional),
    ...
    ;
    var jt, Dt, Lt = se.now(), Ht = /\?/, qt = /#.*$/, Mt = /([?&])_=[^&]*/, _t = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Ft = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ot = /^(?:GET|HEAD)$/, Bt = /^\/\//, Pt = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Rt = se.fn.load, Wt = {}, $t = {}, It = "*/".concat("*");
    try {
        Dt = J.href
    } catch (e) {
    ...
    se.extend({
        ...
        ajax: function(e, n) {
            function r(e, n, r, i) {
                ...
                w && (se.lastModified[a] = w),
                (w = T.getResponseHeader("etag")) && (se.etag[a] = w)),
                204 === e ? (o = !0,
                N = "nocontent") : 304 === e ? (o = !0,
                N = "notmodified") : (o = M(p, b),
                N = o.state,
                f = o.data,
                v = o.error,
                o = !v)) : (v = N,
                ...
                T.status = e,
                T.statusText = (n || N) + "",
                o ? g.resolveWith(d, [f, N, T]) : g.rejectWith(d, [T, N, v]),
                T.statusCode(y),
                y = t,
                l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, p, o ? f : v]),
                m.fireWith(d, [T, N]),
            ...
            e = t),
            n = n || {};
            var i, o, a, s, u, l, c, f, p = se.ajaxSetup({}, n), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? se(d) : se.event, g = se.Deferred(), m = se.Callbacks("once memory"), y = p.statusCode || {}, v = {}, b = {}, x = 0, w = "canceled", T = {
                readyState: 0,
            ...
            T.success = T.done,
            T.error = T.fail,
            p.url = ((e || p.url || Dt) + "").replace(qt, "").replace(Bt, jt[1] + "//"),
            p.type = n.method || n.type || p.method || p.type,
            p.dataTypes = se.trim(p.dataType || "*").toLowerCase().match(le) || [""],
            null == p.crossDomain && (i = Pt.exec(p.url.toLowerCase()),
            p.crossDomain = !(!i || i[1] === jt[1] && i[2] === jt[2] && (i[3] || ("http:" === i[1] ? 80 : 443)) == (jt[3] || ("http:" === jt[1] ? 80 : 443)))),
            p.data && p.processData && "string" != typeof p.data && (p.data = se.param(p.data, p.traditional)),
            L(Wt, p, n, T),
            2 === x)
                return T;
            l = p.global,
            ...
            a = p.url,
            p.hasContent || (p.data && (a = p.url += (Ht.test(a) ? "&" : "?") + p.data,
            delete p.data),
            !1 === p.cache && (p.url = Mt.test(a) ? a.replace(Mt, "$1_=" + Lt++) : a + (Ht.test(a) ? "&" : "?") + "_=" + Lt++)),
            p.ifModified && (se.lastModified[a] && T.setRequestHeader("If-Modified-Since", se.lastModified[a]),
            se.etag[a] && T.setRequestHeader("If-None-Match", se.etag[a])),
    ...
    se.ajaxTransport("script", function(e) {
        if (e.crossDomain) {
            var n, r = Y.head || se("head")[0] || Y.documentElement;
            return {
                send: function(t, i) {
    ...
    se.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = zt.pop() || se.expando + "_" + Lt++;
            return this[e] = !0,
            e
        }
    }),
    se.ajaxPrefilter("json jsonp", function(n, r, i) {
        var o, a, s, u = !1 !== n.jsonp && (Xt.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(n.data) && "data");
        if (u || "jsonp" === n.dataTypes[0])
            return o = n.jsonpCallback = se.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
            u ? n[u] = n[u].replace(Xt, "$1" + o) : !1 !== n.jsonp && (n.url += (Ht.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
    ...
    var Ut, Vt, Yt = 0, Jt = e.ActiveXObject && function() {
        var e;
        for (e in Ut)
            Ut[e](t, !0)
    }
    ...
    (Vt = se.support.ajax = !!Vt) && se.ajaxTransport(function(n) {
        if (!n.crossDomain || se.support.cors) {
            ...
            return {
                send: function(i, o) {
                    ...
                    r = function(e, i) {
                        ...
                        try {
                            if (r && (i || 4 === u.readyState))
                                if (r = t,
                                a && (u.onreadystatechange = se.noop,
                                Jt && delete Ut[a]),
                                i)
                    ...
                    ,
                    n.async ? 4 === u.readyState ? setTimeout(r) : (a = ++Yt,
                    Jt && (Ut || (Ut = {},
                    se(e).unload(Jt)),
                    Ut[a] = r),
    ...
    var Gt, Qt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + ue + ")([a-z%]*)$","i"), en = /queueHooks$/, tn = [W], nn = {
        "*": [function(e, t) {
            var n, r, i = this.createTween(e, t), o = Zt.exec(t), a = i.cur(), s = +a || 0, u = 1, l = 20;
            if (o) {
                if (n = +o[2],
                "px" !== (r = o[3] || (se.cssNumber[e] ? "" : "px")) && s) {
    ...
    $.propHooks = {
        _default: {
            get: function(e) {
                var t;
                return null == e.elem[e.prop] || e.elem.style && null != e.elem.style[e.prop] ? (t = se.css(e.elem, e.prop, ""),
    ...
    se.fn.offset = function(e) {
        ...
        if (a)
            ...
            se.contains(n, o) ? (typeof o.getBoundingClientRect !== V && (i = o.getBoundingClientRect()),
            r = z(a),
            {
    ...
    se.offset = {
        setOffset: function(e, t, n) {
            ...
            var i, o, a = se(e), s = a.offset(), u = se.css(e, "top"), l = se.css(e, "left"), c = ("absolute" === r || "fixed" === r) && se.inArray("auto", [u, l]) > -1, f = {}, p = {};
            c ? (p = a.position(),
            i = p.top,
    ...
    se.fn.extend({
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === se.css(r, "position") ? t = r.getBoundingClientRect() : (e = this.offsetParent(),
                t = this.offset(),
                se.nodeName(e[0], "html") || (n = e.offset()),
                n.top += se.css(e[0], "borderTopWidth", !0),
                n.left += se.css(e[0], "borderLeftWidth", !0)),
                {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Y.documentElement; e && !se.nodeName(e, "html") && "static" === se.css(e, "position"); )
                    e = e.offsetParent;
    ...
    se.each({
        ...
        se.fn[e] = function(i) {
            return se.access(this, function(e, i, o) {
                ...
                a ? a.scrollTo(r ? se(a).scrollLeft() : o, r ? o : se(a).scrollTop()) : e[i] = o
        ...
        se.each({
            ...
            se.fn[i] = function(i, o) {
                ...
                return se.access(this, function(n, r, i) {
                    var o;
                    return se.isWindow(n) ? n.document.documentElement["client" + e] : 9 === n.nodeType ? (o = n.documentElement,
                    Math.max(n.body["scroll" + e], o["scroll" + e], n.body["offset" + e], o["offset" + e], o["client" + e])) : i === t ? se.css(n, r, s) : se.style(n, r, i, s)
                }, n, a ? i : t, a, null)
            }
        })
    }),
