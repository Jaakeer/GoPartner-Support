!(function(e) {
    ...
    function i() {
        ...
        var c, l = n(130), d = n(117), f = n(131), g = {
            "layers": [],
            "interestGroups": [],
            "listTargetingKeys": [],
            "groups": [],
            "views": [{
                ...
                "staticConditions": ["or", ["or", {
                    "type": "url",
                    "value": "/categories/360000049043",
                    "match": "substring"
                }]],
                "name": "Help Center - Categories - Getting Started",
                "apiName": "12119108777_help_center__categories__getting_started",
                "tags": [],
                ...
                "staticConditions": ["or", ["or", {
                    "type": "url",
                    "value": "https://get.slack.help/hc(/[a-z]{2}(-[a-z]{2})?/?)$",
                    "match": "regex"
                }]],
                "name": "Help Center - Home",
                "apiName": "12119108777_help_center__home",
                "tags": [],
                "undoOnDeactivation": false,
                "deactivationEnabled": false,
                "id": "12116916410"
            }],
            "projectId": "12119108777",
            "dimensions": [],
            "namespace": "12119108777",
            "integrationSettings": [],
            "dcpKeyfieldLocators": [{
                "dcp_datasource_id": "11368885107",
                "is_optimizely": false,
                "type": "query_param",
                "name": "team_id"
            }, {
                "dcp_datasource_id": "11399363358",
                "is_optimizely": false,
                "type": "query_param",
                "name": "user_id"
            }, {
                "dcp_datasource_id": "14358440581",
                "is_optimizely": true,
                "type": "uid",
                "name": ""
            }],
            "dcpServiceId": "11386737149",
            "audiences": [],
            "anonymizeIP": true,
            "tagGroups": [],
            "visitorAttributes": [],
            "accountId": "11179690159",
            "events": [],
            "experimental": {
                "trimPages": false
            },
        ...
        if (d.populateDirectiveData(),
        s.clientHasAlreadyInitialized())
            return void a.warn("Main / Disabling because Optimizely has already initialized on this page load. Are there multiple snippets on the page?");
        if (s.shouldBailForDesktopApp())
            return void a.log("Main / Disabling because of desktop app.");
        if (s.conflictInObservingChanges())
            return void a.log("Main / Disabling: Observe Changes Indefinitely is on, but browser does not support it.");
        if (s.shouldLoadInnie())
            ...
            var h;
            h = s.isSlave() ? window.optimizely : window.optimizely = window.optimizely || [],
            h.push({
                type: "load",
                data: g
            }),
            a.log("Main / Disabling in favor of the preview client."),
            n(147).setupPreviewGlobal(),
            n(147).pushToPreviewGlobal({
            ...
            f.addScriptSync("https://cdn-assets-prod.s3.amazonaws.com/js/preview2/12119108777.js"))
            ...
            c = t(s.getProjectToken(), v, s.getPreviewLayerIds()),
            f.addScriptSync(c),
            n(147).setupPreviewGlobal(),
            f.addScriptAsync("/dist/js/preview_ui.js")
        } else
            s.shouldBootstrapDataForEditor() ? (l.registerFunction("initializeOptimizelyPreview", e),
    ...
    function a(e) {
        return _.isEmpty(e) ? R.resolve() : r((function() {
            return N.request({
                ...
                return E.resolveRequest("RUM_FIRST_BEACON", e),
                e
            }
            ))["catch"]((function(e) {
                throw w.error("POST to client-rum failed:", e),
    ...
    function u() {
        ...
        if (e) {
            ...
            try {
                ...
                if (t)
                    return _.mapValues(P.ResourceTimingAttributes, (function(e, n) {
                        var i = t[n];
        ...
        if (e)
            try {
                ...
                return _.reduce(t, (function(e, t) {
                    return e[t.name] = Math.round(t.startTime),
                    e
                }
                ), {})
            } catch (e) {
    ...
    t.queueBeacons = function() {
        return x.getSampleRum() ? (S.isLoaded() ? O.setTimeout(g, z) : O.addEventListener("load", g),
        new R(function(e, t) {
    ...
    (function(e, n) {
        (function() {
            ...
            function m(e, t) {
                if (e !== t) {
                    var n = null === e
                      ...
                      , o = t === An
                      , s = t === t;
                    if (e > t && !a || !r || n && !o && s || i && s)
                        return 1;
                    if (e < t && !n || !s || a && !i && r || o && r)
                        return -1
                }
                return 0
            }
            ...
            function S(e, t) {
                return e = "number" == typeof e || di.test(e) ? +e : -1,
                t = null == t ? Vn : t,
                e > -1 && e % 1 == 0 && e < t
            }
            function T(e) {
            ...
            function M(e, t) {
                var n = this.d;
                return Ze(e) ? P("string" == typeof e ? n.string : n.hash, e, t) : Yi ? n.map.set(e, t) : J(n.map, e, t),
                this
            }
            function U(e) {
                var t = -1
                  , n = e ? e.length : 0;
                for (this.d = new L; ++t < n; )
                    this.push(e[t])
            }
            function G(e, t) {
                var n = e.d;
            ...
            function q(e, t) {
                var n = this.d
                  , i = n.array;
                i && (i.length < bn - 1 ? J(i, e, t) : (n.array = null,
                n.map = new L(i)));
                var r = n.map;
                return r && r.set(e, t),
                this
            ...
            function X(e, t) {
                ...
                if (n < 0)
                    return !1;
                var i = e.length - 1;
                return n == i ? e.pop() : zi.call(e, n, 1),
                !0
            }
            function W(e, t) {
                var n = $(e, t);
            ...
            function Se(e, t, n, i, r, a, o) {
                ...
                var l = a ? a(s, u, n + "", e, t, o) : An
                  , d = l === An;
                d && (l = u,
                dr(u) || $t(u) ? dr(s) ? l = s : Vt(s) ? l = Re(s) : (d = !1,
                l = re(u, !a)) : Xt(u) || Pt(u) ? Pt(s) ? l = tn(s) : !zt(s) || i && Gt(s) ? (d = !1,
                l = re(u, !a)) : l = s : d = !1),
                o.set(u, l),
                d && r(l, u, i, a, o),
                o["delete"](u),
            ...
            function je(e, t, n, i) {
                function r() {
                    for (var t = -1, s = arguments.length, u = -1, c = i.length, l = Array(c + s), d = this && this !== Ti && this instanceof r ? o : e; ++u < c; )
                        l[u] = i[u];
                    for (; s--; )
                        l[u++] = arguments[++t];
            ...
            function We(e) {
                var t = e.length
                  , n = e.constructor(t);
                return t && "string" == typeof e[0] && Ri.call(e, "index") && (n.index = e.index,
                n.input = e.input),
                n
            }
            function Qe(e) {
            ...
            function mt(e, t, n, i) {
                ...
                n = n && !i ? gr(n) : 0;
                var r = e.length;
                return n < 0 && (n = Ki(r + n, 0)),
                Qt(e) ? n <= r && e.indexOf(t, n) > -1 : !!r && f(e, t, n) > -1
            }
            function Et(e, t) {
                return Ee(e, ve(t))
            }
            ...
            function Rt(e, t) {
                ...
                function() {
                    for (var n = arguments, i = -1, r = Ki(n.length - t, 0), a = Array(r); ++i < r; )
                        a[i] = n[t + i];
                    var o = Array(t + 1);
                    for (i = -1; ++i < t; )
                        o[i] = n[i];
            ...
            function Ft(e) {
                if (Lt(e) && (dr(e) || Qt(e) || Gt(e.splice) || Pt(e)))
                    return !e.length;
                for (var t in e)
                    if (Ri.call(e, t))
                        return !1;
            ...
            function sn(e) {
                ...
                var n = Je(e)
                  ...
                  , a = r.length;
                for (var o in e)
                    !Ri.call(e, o) || i && ("length" == o || S(o, a)) || t && "constructor" == o || r.push(o);
                return r
            }
            function un(e) {
            ...
            function mn(e, t, n) {
                var i = sn(t)
                  , r = ge(t, i);
                null != n || zt(t) && (r.length || !i.length) || (n = t,
                t = e,
                e = this,
                r = ge(t, sn(t)));
            ...
            var An, wn = "4.6.1", bn = 200, Rn = "Expected a function", Dn = "__lodash_hash_undefined__", On = 1, Nn = 32, Cn = 1, Pn = 2, Ln = 1 / 0, Vn = 9007199254740991, kn = "[object Arguments]", xn = "[object Array]", Fn = "[object Boolean]", Mn = "[object Date]", Un = "[object Error]", Gn = "[object Function]", Bn = "[object GeneratorFunction]", zn = "[object Map]", jn = "[object Number]", Hn = "[object Object]", Kn = "[object RegExp]", Yn = "[object Set]", qn = "[object String]", Xn = "[object Symbol]", Wn = "[object WeakMap]", Qn = "[object ArrayBuffer]", $n = "[object Float32Array]", Jn = "[object Float64Array]", Zn = "[object Int8Array]", ei = "[object Int16Array]", ti = "[object Int32Array]", ni = "[object Uint8Array]", ii = "[object Uint8ClampedArray]", ri = "[object Uint16Array]", ai = "[object Uint32Array]", oi = /[&<>"'`]/g, si = RegExp(oi.source), ui = /[\\^$.*+?()[\]{}|]/g, ci = /\w*$/, li = /^\[object .+?Constructor\]$/, di = /^(?:0|[1-9]\d*)$/, fi = {};
            fi[$n] = fi[Jn] = fi[Zn] = fi[ei] = fi[ti] = fi[ni] = fi[ii] = fi[ri] = fi[ai] = !0,
            fi[kn] = fi[xn] = fi[Qn] = fi[Fn] = fi[Mn] = fi[Un] = fi[Gn] = fi[zn] = fi[jn] = fi[Hn] = fi[Kn] = fi[Yn] = fi[qn] = fi[Wn] = !1;
            var gi = {};
            gi[kn] = gi[xn] = gi[Qn] = gi[Fn] = gi[Mn] = gi[$n] = gi[Jn] = gi[Zn] = gi[ei] = gi[ti] = gi[zn] = gi[jn] = gi[Hn] = gi[Kn] = gi[Yn] = gi[qn] = gi[Xn] = gi[ni] = gi[ii] = gi[ri] = gi[ai] = !0,
            gi[Un] = gi[Gn] = gi[Wn] = !1;
            var pi = {
                "&": "&amp;",
                "<": "&lt;",
            ...
            : hn(!1)
              ...
              , Ir = Rt((function(e, t) {
                return null == e ? {} : (t = Ee(le(t, 1), String),
                Te(e, se(un(e), t)))
            }
            ))
              , yr = Rt((function(e, t) {
              ...
              , Sr = ve;
            R.prototype = ae(b.prototype),
            R.prototype.constructor = R,
            D.prototype = Wi ? Wi(null) : wi,
            L.prototype.clear = V,
            ...
            b.VERSION = wn,
            tr(["pop", "join", "replace", "reverse", "split", "push", "shift", "sort", "splice", "unshift"], (function(e) {
            ...
            b.prototype.toJSON = b.prototype.valueOf = b.prototype.value = gt,
            (yi || Ii || {})._ = b,
            vi && _i && (mi && ((_i.exports = b)._ = b),
            vi._ = b)
        }
        ).call(this)
    }
    ...
    i.prototype.dispatch = function(e, t) {
        this.dispatchId++,
        a.each(this.S, a.bind((function(n) {
            n.call(this, e, t)
        }
        ), this)),
        ...
        a.forOwn(this.f, a.bind((function(e, t) {
            e.hasChanges() && this.g[t] && (e.resetChange(),
	 ...
	 */
        !(function(t, n) {
            ...
            function T(e, t, n) {
                t.constructor === e.constructor && n === p && t.constructor.resolve === h ? S(e, t) : n === ue ? (R(e, ue.error),
                ue.error = null) : void 0 === n ? b(e, t) : r(n) ? y(e, t, n) : b(e, t)
            }
            function A(t, n) {
            ...
            function x(e, t) {
                ...
                this._enumerate(),
                0 === this._remaining && b(this.promise, this._result))) : R(this.promise, F())
            }
            function F() {
            ...
            function j(e) {
                ...
                this._subscribers = [],
                v !== e && ("function" != typeof e && B(),
                this instanceof j ? L(this, e) : z())
            }
            function H() {
                var e = void 0;
            ...
            return x.prototype._enumerate = function() {
                for (var e = this.length, t = this._input, n = 0; this._state === ae && n < e; n++)
            ...
            x.prototype._settledAt = function(e, t, n) {
                var i = this.promise;
                i._state === ae && (this._remaining--,
                e === se ? R(i, n) : this._result[t] = n),
    ...
    i.prototype.register = function(e, t) {
        ...
        if (this.V[e])
            throw new Error("Module already registered for: " + e);
        this.V[e] = t
    }
    ,
    ...
    t.getFieldValue = function(e, t) {
        ...
        for (var n = e, r = 0; r < t.length; r++) {
            var a = t[r];
            if (!i.isObject(n) || !n.hasOwnProperty(a))
                return;
            n = n[a]
        }
        return n
    ...
    t.deepFreeze = function e(t) {
        r && i.isObject(t) && !i.isFunction(t) && (i.forOwn(t, e),
        Object.freeze(t))
    }
    ,
    ...
    i.prototype.setLogLevel = function(e) {
        var t = this.B(e);
        null === t ? console.error("Unknown log level: " + e) : this.logLevel !== t && (this.log("Setting log level to " + t),
        this.logLevel = t,
        this.flush())
    }
    ,
    ...
    i.prototype.matchesLogMessage = function(e, t) {
        ...
        if (!this.logMatcher)
            return !0;
        if (this.logGroup)
            return "GROUPSTART" === e ? this.logGroup++ : "GROUPEND" === e && this.logGroup--,
            !0;
        ...
        return i && "GROUPSTART" === e && this.logGroup++,
        i
    }
    ,
    ...
    i.prototype.z = function(e, t, n) {
        ...
        try {
            n || this.G() && !this.shouldLog(a) || (r.isArray(t) && r.isString(t[0]) && (t = this.j(t)),
            this.storeLog(e, t)),
            i && this.shouldLog(a) && this.matchesLogMessage(e, t) && i.apply(console, t)
        } catch (e) {
    ...
    i.prototype.logAlways = function() {
        ...
        console && console.log && console.log.apply && console.log.apply(console, e),
    ...
    i.prototype.error = function(e) {
        ...
        1 === t.length && e.stack ? (this.z(s.LogLevel.ERROR, [this.H(), e]),
        this.z(s.LogLevel.INFO, [e.stack])) : this.z(s.LogLevel.ERROR, t)
    }
    ,
    ...
    i.prototype.B = function(e) {
        ...
        "FALSE" === e && (e = "OFF"),
        "ALL" === e && (e = "DEBUG"),
        !r.isUndefined(s.LogLevel[e])) ? s.LogLevel[e] : null
    }
    ,
    e.exports = new i
}
    ...
    function i(e) {
        var t = [Array.prototype]
          , n = [];
        r.each(t, (function(e) {
            r.isUndefined(e.toJSON) || (n.push(e.toJSON),
            delete e.toJSON)
        }
        ));
        var i, a;
    ...
    e.exports = {
        initialize: function() {
            this.L = {},
            i.each(a.Lifecycle, i.bind((function(e) {
                this.L[e] = []
            }
            ), this)),
            this.on(r.ADD_CLEANUP_FN, this.W),
        ...
        W: function(e) {
            this.L[e.lifecycle].push(e.cleanupFn),
            this.emitChange()
        },
        Q: function(e) {
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(i.SET_COOKIE_DOMAIN, this.$),
            this.on(i.SET_COOKIE_AGE, this.J),
            this.on(i.SET_COOKIE_AUTO_REFRESH, this.Z)
        },
        ...
        $: function(e) {
            this.L.currentDomain = e,
            this.emitChange()
        },
        J: function(e) {
            this.L.defaultAgeSeconds = e,
            this.emitChange()
        },
        Z: function(e) {
            this.L.autoRefresh = e,
            this.emitChange()
        }
    }
}
    ...
    function i(e) {
        var t = [];
        return e && r.isObject(e) ? (e.type && t.push(e.type),
        t.push(o),
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(a.ADD_EMITTER_HANDLER, this.ee),
            this.on(a.REMOVE_EMITTER_HANDLER, this.te)
        },
        ...
        ee: function(e) {
            var t = i(e.filter);
            this.L.handlers[t] || (this.L.handlers[t] = []),
            this.L.handlers[t].push({
                handler: e.handler,
                token: e.token,
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.DATA_LOADED, this.re),
            this.on(r.ACTIVATE, this.ae),
            this.on(r.RECORD_GLOBAL_DECISION, this.oe),
            this.on(r.SET_DOMCONTENTLOADED, this.se)
        },
        ...
        ae: function(e) {
            this.L.activationId = e.activationId,
            this.L.activationTimestamp = e.activationTimestamp,
            this.L.isGlobalHoldback = null
        },
        oe: function(e) {
            var t = e.isGlobalHoldback;
            if (null !== this.L.isGlobalHoldback && this.L.isGlobalHoldback !== t)
                throw new Error("Attempted to change already set global holdback!");
            this.L.isGlobalHoldback = t,
            this.emitChange()
        },
        re: function(e) {
    ...
    e.exports = {
        ...
        ue: function(e) {
            i.isUndefined(e.effectiveReferrer) || (this.L.effectiveReferrer = e.effectiveReferrer),
            i.isUndefined(e.effectiveVariationId) || (this.L.effectiveVariationId = e.effectiveVariationId),
            this.emitChange()
        }
    }
}
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.ENSURE_ORIGINAL_PUSHSTATE, this.ce),
            this.on(r.ENSURE_ORIGINAL_REPLACESTATE, this.le)
        },
    ...
    e.exports = {
        initialize: function() {
            this.L = {},
            this.on(r.DATA_LOADED, this.k),
            this.on(r.SET_INTEGRATION_SETTINGS, this.de)
        },
        k: function(e) {
    ...
    e.exports = {
        initialize: function() {
            this.L = {},
            this.on(r.LOAD_PERSISTED_LAYER_STATES, this.fe),
            this.on(r.RECORD_LAYER_DECISION, this.ge),
            this.on(r.RECORD_LAYER_DECISION_EVENT_ID, this.pe)
        },
        getLayerState: function(e, t) {
            if (this.L[e]) {
                var n = this.L[e];
                if (i.keys(n).length > 1 && !t)
                    throw new Error("View Id must be specified when more than one layerState for layer.");
            ...
            if (!i.isEmpty(e.data.layers)) {
                ...
                i.each(e.data.layers, (function(e) {
                    i.each(e.experiments, (function(n) {
                        ...
                        n.campaignName || o.isSingleExperimentPolicy(e.policy) ? o.isSingleExperimentPolicy(e.policy) && e.groupId && (n.groupId = e.groupId) : n.campaignName = e.name,
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(i.LOAD_REDIRECT_DATA, this.ve),
    ...
    e.exports = {
        ...
        ye: function() {
            for (var e = i.sortBy(this.L, "timeStamp"), t = 0; t <= e.length - o; t++)
                delete this.L[e[t].id];
            this.emitChange()
        }
    }
}
    ...
    e.exports = {
        initialize: function() {
            this.L = {},
            this.L[a.PerformanceData.performance_marks] = {},
            this.on(r.SET_PERFORMANCE_MARKS_DATA, this.Se)
        },
        Se: function(e) {
            i.isUndefined(this.L[a.PerformanceData.performance_marks][e.name]) && (this.L[a.PerformanceData.performance_marks][e.name] = []),
            this.L[a.PerformanceData.performance_marks][e.name].push(e.data),
            this.emitChange()
        },
        getMarks: function() {
    ...
    e.exports = {
        ...
        Te: function(e) {
            var t = e.type
              ...
              , i = e.plugin;
            if (!t || !n)
                throw new Error("Missing information needed to register plugins: " + t + ":" + n);
            if (!this.L[t])
                throw new Error("Invalid plugin type specified: " + t);
            this.L[t][n] = i,
            o.debug("Plugin Store: Registering Plugin :", e)
        },
        ...
        getPlugin: function(e, t) {
            if (!t || !e)
                throw new Error("Missing plugin parameters");
    ...
    e.exports = {
        initialize: function() {
            this.L = {},
            this.on(r.SET_VISITOR_ATTRIBUTE_PENDING, this.Ae)
        },
        getPendingAttributeValue: function(e) {
            return e = i.isArray(e) ? e.concat("pending") : [e, "pending"],
            a.getFieldValue(this.L, e)
        },
        Ae: function(e) {
    ...
    e.exports = {
        ...
        ve: function(e) {
            this.isExpectingRedirect() || (this.L.layerId = e.layerId,
            this.emitChange())
        }
    }
}
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.RECORD_CHANGE_MACROTASK_RATE, this.De),
            this.on(r.RECORD_CHANGE_OVERHEATED, this.Oe),
            this.on(r.RECORD_DOM_OBSERVATION_OCCURENCE, this.Ne)
        },
        we: function(e) {
            i.merge(this.L, e),
            this.emitChange()
        ...
        be: function(e) {
            this.L.apis[e.methodName] || (this.L.apis[e.methodName] = 0),
            this.L.apis[e.methodName]++,
            this.emitChange()
        },
        Re: function() {
            i.isUndefined(this.L.data.extras.changeMacrotaskRate) && (this.L.data.extras.changeMacrotaskRate = 0),
            i.isUndefined(this.L.data.extras.numOverheatedChanges) && (this.L.data.extras.numOverheatedChanges = 0)
        },
        De: function(e) {
            i.isUndefined(this.L.data.extras.changeMacrotaskRate) && (this.L.data.extras.changeMacrotaskRate = 0),
            e.changeMacrotaskRate > this.L.data.extras.changeMacrotaskRate && (this.L.data.extras.changeMacrotaskRate = e.changeMacrotaskRate),
            this.emitChange()
        },
        Oe: function() {
            i.isUndefined(this.L.data.extras.numOverheatedChanges) && (this.L.data.extras.numOverheatedChanges = 0),
            this.L.data.extras.numOverheatedChanges++,
            this.emitChange()
        },
        Ne: function(e) {
            this.L.DOMObservation[e.counterName] || (this.L.DOMObservation[e.counterName] = 0),
            this.L.DOMObservation[e.counterName]++,
            this.emitChange()
        },
    ...
    e.exports = {
        ...
        Ce: function(e) {
            ...
            this.L.natives = e.sandboxedFunctions,
            this.L.initialized = !0,
            this.emitChange()
        },
        getAll: function() {
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.REFRESH_SESSION, this.Pe),
            this.on(r.LOAD_SESSION_STATE, this.Le)
        },
        getState: function() {
            return i.cloneDeep(this.L)
        },
        ...
        Le: function(e) {
            this.L.sessionId = e.sessionId,
            this.L.lastSessionTimestamp = e.lastSessionTimestamp,
            this.emitChange()
        },
        Pe: function() {
            var e = a.now()
              , t = this.L.lastSessionTimestamp;
            (!this.L.sessionId || e - t > s) && (this.L.sessionId = o.generate()),
            this.L.lastSessionTimestamp = e,
            this.emitChange()
        }
    }
}
    ...
    e.exports = {
        initialize: function() {
            this.Ve(),
            this.on(r.FINALIZE_BATCH_SNAPSHOT, this.ke),
            this.on(r.REGISTER_PREVIOUS_BATCH, this.xe),
            this.on(r.REGISTER_TRACKER_VISITOR, this.Fe),
            this.on(r.REGISTER_TRACKER_EVENT, this.Me),
            this.on(r.REGISTER_TRACKER_DECISION, this.Ue),
            this.on(r.RESET_TRACKER_EVENTS, this.Ge),
            this.on(r.RESET_TRACKER_STORE, this.Ve),
            this.on(r.RESET_TRACKER_PREVIOUS_BATCHES, this.Be),
            this.on(r.SET_TRACKER_POLLING, this.ze),
            this.on(r.SET_TRACKER_BATCHING, this.je),
            this.on(r.SET_TRACKER_SEND_EVENTS, this.He),
            this.on(r.SET_TRACKER_PERSISTABLE_STATE, this.Ke),
            this.on(r.SET_TRACKER_DIRTY, this.Ye),
            this.on(r.UPDATE_TRACKER_VISITOR_ATTRIBUTES, this.qe)
        },
        ...
        Ke: function(e) {
            i.isEmpty(this.L.data) || i.isEmpty(e.data) || (this.ke(),
            this.L.previousBatches.push(this.getEventBatch())),
            this.L.data = e.data || {},
            this.L.decisions = e.decisions || [],
            this.L.decisionEvents = e.decisionEvents || [],
            i.isEmpty(this.L.previousBatches) || i.isEmpty(e.previousBatches) ? this.L.previousBatches = e.previousBatches || [] : this.L.previousBatches = this.L.previousBatches.concat(e.previousBatches),
            this.emitChange()
        },
        Ye: function(e) {
            this.L.isDirty = e,
        ...
        Me: function(e) {
            var t = this.Xe();
            !i.isEmpty(t.snapshots) && i.isEmpty(this.L.decisionEvents) || this.We(),
            this.Qe().events.push(e.event),
            this.L.decisions = e.decisions,
            this.Ye(!0)
        },
        Ue: function(e) {
            this.L.decisionEvents.push(e.decisionEvent),
            this.L.decisions = e.decisions,
            this.Ye(!0)
        },
        Fe: function(e) {
            i.isEmpty(this.L.data) ? this.L.data = e.data : this.ke(),
            this.L.data.visitors.push(e.visitor),
            this.L.decisions = e.decisions,
            this.L.decisionEvents = [],
            this.Ye(!0)
        },
        xe: function(e) {
            this.L.previousBatches.push(e),
            this.Ye(!0)
        },
        Ve: function() {
            this.L = {
        ...
        Ge: function() {
            var e = this.Xe();
            this.L.data.visitors = [e],
            e.snapshots = [],
            this.Ye(!0)
        },
        Be: function() {
            this.L.previousBatches = [],
            this.Ye(!0)
        },
        ze: function(e) {
            this.L.polling = e,
        ...
        ke: function() {
            this.L.decisionEvents.length > 0 && this.We()
        },
        hasEventsToSend: function() {
            if (!i.isEmpty(this.L.decisionEvents))
                return !0;
    ...
    e.exports = {
        initialize: function() {
            this.L = i.cloneDeep(o),
            this.on(r.REGISTER_VIEWS, this.et),
            this.on(r.SET_VIEW_ACTIVE_STATE, this.tt),
            this.on(r.UPDATE_PARSED_VIEW_METADATA, this.nt),
            this.on(r.UPDATE_USER_SUPPLIED_METADATA, this.it),
            this.on(r.TRACK_VIEW_ACTIVATED_EVENT, this.rt),
            this.on(r.SET_GLOBAL_TAGS, this.at),
            this.on(r.ACTIVATE, this.ot),
            this.on(r.SET_VIEW_BATCHING, this.je)
        },
        getAll: function() {
            var e = {};
            for (var t in this.L.viewStates)
                e[t] = this.getViewState(t);
            return e
        },
        shouldBatch: function() {
            return this.L.shouldBatch
        ...
        getViewState: function(e) {
            var t = i.cloneDeep(this.L.viewStates[e])
              , n = this.L.globalTags;
            return t.metadata = i.extend({}, t.parsedMetadata, n, t.userSuppliedMetadata),
            t
        },
        ...
        getActiveViewStates: function() {
            return i.reduce(this.L.viewStates, i.bind((function(e, t, n) {
                return this.isViewActive(n) && e.push(this.getViewState(n)),
                e
            }
            ), this), [])
        },
        isViewActive: function(e) {
            ...
            return t || a.warn("No Page registered with id", e),
            !!t.isActive
        },
        ...
        tt: function(e) {
            var t = e.view.id;
            if (!this.L.viewStates[t])
                throw new Error("No view exists with id " + t);
            this.L.viewStates[t].isActive = e.isActive,
            e.isActive ? this.L.viewStates[t].activatedTimestamp = e.timestamp : (this.L.viewStates[t].parsedMetadata = {},
            this.L.viewStates[t].userSuppliedMetadata = {}),
            this.emitChange()
        },
        nt: function(e) {
            var t = e.pageId;
            if (!this.L.viewStates[t])
                throw new Error("No view exists with id " + t);
            i.assign(this.L.viewStates[t].parsedMetadata, e.metadata),
            this.emitChange()
        },
        it: function(e) {
            var t = e.pageId;
            if (!this.L.viewStates[t])
                throw new Error("No view exists with id " + t);
            i.assign(this.L.viewStates[t].userSuppliedMetadata, e.metadata),
            this.emitChange()
        },
        rt: function(e) {
            var t = e.pageId;
            this.L.viewStates[t] && (this.L.viewStates[t].activationEventId = e.eventData.eventId,
            this.emitChange())
        },
        at: function(e) {
            i.extend(this.L.globalTags, e),
            this.emitChange()
        },
        je: function(e) {
            this.L.shouldBatch = e,
    ...
    e.exports = {
        ...
        k: function(e) {
            i.isEmpty(e.data.views) || (i.each(e.data.views, i.bind((function(e) {
                a.deepFreeze(e),
                this.L.views[e.id] = e,
                this.L.apiNamesToViews[e.apiName] = e
            }
            ), this)),
            this.emitChange())
        }
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.SET_VISITOR_ATTRIBUTES, this.st),
        ...
        ut: function(e) {
            this.L.profile = e.profile,
            this.L.metadata = e.metadata,
            this.emitChange()
        },
        st: function(e) {
            i.each(e.attributes, i.bind((function(e) {
                var t = e.key;
                a.setFieldValue(this.L.profile, t, e.value),
                e.metadata && i.forOwn(e.metadata, i.bind((function(e, n) {
    ...
    e.exports = {
        ...
        getVisitorAttribute: function(e) {
            ...
            if (e.attributeName) {
                ...
                if (r.length > 1)
                    throw new Error("Too many attributes with name: " + e.attributeName);
                return r[0]
            }
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(i.SET_VISITOR_EVENTS, this.k),
            this.on(i.SET_FOREIGN_VISITOR_EVENTS, this.dt),
            this.on(i.SET_FOREIGN_VISITOR_EVENT_QUEUE, this.ft)
        },
        getEvents: function() {
    ...
    i.prototype.digest = function() {
        var e = function(e, t) {
          ...
          , t = [];
        if (t.push(e(o.FIELDS.NAME, this[o.FIELDS.NAME])),
        t.push(e(o.FIELDS.TYPE, this[o.FIELDS.TYPE])),
        this[o.FIELDS.CATEGORY] && t.push(e(o.FIELDS.CATEGORY, this[o.FIELDS.CATEGORY])),
        this[o.FIELDS.REVENUE] && t.push(e(o.FIELDS.REVENUE, this[o.FIELDS.REVENUE])),
    ...
    i.prototype.hash = function() {
        return this.hash_ ? this.hash_ : (this.hash_ = u.hashToHex(u.toByteString(this.digest()), u.Seed.BEHAVIOR_EVENT),
        this.hash_)
    }
    ,
    ...
    i.prototype.equals = function(e) {
        if (this.hash() !== e.hash())
            return !1;
        if (this[o.FIELDS.NAME] !== e[o.FIELDS.NAME] || this[o.FIELDS.TYPE] !== e[o.FIELDS.TYPE] || this[o.FIELDS.CATEGORY] !== e[o.FIELDS.CATEGORY] || this[o.FIELDS.REVENUE] !== e[o.FIELDS.REVENUE])
            return !1;
        if (!this[o.FIELDS.OPTIONS] && !e[o.FIELDS.OPTIONS])
            return !0;
    ...
    i.prototype.setFieldValue = function(e, t) {
        e !== o.FIELDS.NAME && e !== o.FIELDS.TYPE && e !== o.FIELDS.CATEGORY && e !== o.FIELDS.REVENUE && e !== o.FIELDS.OPTIONS || (this[e] = t,
        this.reHash())
    }
    ,
    t.Event = r,
    ...
    r.prototype.readableEvent = function() {
        ...
        var s = [];
        if (e = c[o.FIELDS.OPTIONS],
        t = i.getValueOrDefault([o.FIELDS.OPTIONS]),
        a.isUndefined(t) || (a.each(t, (function(e, t) {
            s.push(t + ": " + String(n(e)))
        }
        )),
        r.push(e + ": {\n\t\t" + s.join(",\n\t\t") + "\n\t}")),
    ...
    r.prototype.toObject = function(e) {
        ...
        a.each([o.FIELDS.NAME, o.FIELDS.TYPE, o.FIELDS.CATEGORY, o.FIELDS.REVENUE, o.FIELDS.OPTIONS, o.FIELDS.SESSION_INDEX], (function(e) {
            t = c[e],
            n = r.getValueOrDefault([e], e === o.FIELDS.OPTIONS ? {} : void 0),
            a.isUndefined(n) || (i[t] = n)
        }
        ));
        var s = c[o.FIELDS.OPTIONS]
          , u = c[o.FIELDS.REVENUE];
        if (e && e.revenueAsTag && i[u] && (i[s] = i[s] || {},
        i[s][u] = i[u],
        delete i[u]),
    ...
    !(function() {
        ...
        function n(e, t) {
            ...
            s = 461845907,
            c = 0; c < i; )
                u = 255 & e.charCodeAt(c) | (255 & e.charCodeAt(++c)) << 8 | (255 & e.charCodeAt(++c)) << 16 | (255 & e.charCodeAt(++c)) << 24,
                ++c,
                u = (65535 & u) * o + (((u >>> 16) * o & 65535) << 16) & 4294967295,
                u = u << 15 | u >>> 17,
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.UPDATE_VARIATION_ID_MAP, this.ht),
            this.on(r.MERGE_VARIATION_ID_MAP, this.vt),
            this.on(r.UPDATE_PREFERRED_LAYER_MAP, this._t),
            this.on(r.MERGE_PREFERRED_LAYER_MAP, this.mt)
        },
        ...
        ht: function(e) {
            var t = this.L.variationIdMap
              , n = t[e.layerId] || {};
            n[e.experimentId] !== e.variationId && (n[e.experimentId] = e.variationId,
            this.L.variationIdMap[e.layerId] = n,
            this.emitChange())
        },
        vt: function(e) {
        ...
        _t: function(e) {
            this.L.preferredLayerMap[e.groupId] !== e.layerId && (this.L.preferredLayerMap[e.groupId] = e.layerId,
            this.emitChange())
        },
        mt: function(e) {
    ...
    e.exports = {
        initialize: function() {
            ...
            this.on(r.XDOMAIN_SET_MESSAGE, this.yt),
            this.on(r.XDOMAIN_ADD_SUBSCRIBER, this.St),
            this.on(r.XDOMAIN_SET_CANONICAL_ORIGINS, this.Tt),
            this.on(r.XDOMAIN_SET_DISABLED, this.At)
        },
    ...
    t.addEvent = function(e) {
        ...
        o(t),
        a(d().concat(t)),
        R.reindexIfNecessary(f(), c(), d()),
        T.Rt(d())
    }
    ,
    t.getEvents = function() {
        return d().length > 0 && (h() && R.sessionize(c()),
        T.Dt(c()),
        T.Rt(d())),
        c()
    }
    ...
    T.Ot = function(e, t) {
        ...
        var n = !1
          , r = e[0] || t[0];
        return C.EVENTBASE in r ? (i(T.Nt(e)),
        a(T.Nt(t))) : (n = !0,
        i(T.Ct(e)),
        a(T.Ct(t))),
        d().length > 0 && (h(),
        n = !0),
        i(T._updateBaseMapAndMaybeDedupe(c())),
        T._migrateEventBasesAndUpdateStore() && (n = !0),
        n
    }
    ,
    T.Ct = function(e) {
    ...
    T._migrateEventBasesAndUpdateStore = function() {
        var e = !1
          , t = T.Lt();
        return R.applyMigrations(t) && (e = !0,
        r({}),
        i(T._updateBaseMapAndMaybeDedupe(c())),
    ...
    ,
    T.bt = function(e) {
        var t, n = e.name, i = e.type || "default", r = e.category || E.OTHER, a = e.tags || {};
        e.revenue && (t = e.revenue);
        var o = new b(n,i,r,a,t);
        o = T.kt(o);
        var s = T.Vt()
          , u = new A(o,s,-1);
        return R.updateSessionId(f(), u),
        R.updateSessionIndex(f(), u),
        u
    }
    ,
    T._updateBaseMapAndMaybeDedupe = function(e) {
        for (var t = 0; t < e.length; t++)
            e[t].eventBase = T.kt(e[t].eventBase);
        return e
    }
    ,
    T.Dt = function(e) {
    ...
    T.Lt = function() {
        var e = []
          , t = l();
        for (var n in t)
            t.hasOwnProperty(n) && (e = e.concat(t[n]));
        return e
    }
    ,
    T.xt = function(e) {
        for (var t = function(e) {
            var t = {};
            t[w.FIELDS.NAME] = e.getValueOrDefault([w.FIELDS.NAME]),
            t[w.FIELDS.TYPE] = e.getValueOrDefault([w.FIELDS.TYPE]);
            ...
            return v.isUndefined(r) || (t[w.FIELDS.OPTIONS] = r),
            t
        }, n = C, i = [], r = "_idx_", a = 0; a < e.length; a++) {
            var o, s, u = e[a], c = u.eventBase;
        ...
        for (a = 0; a < e.length; a++)
            delete e[a].eventBase[r];
        return i
    }
    ,
    T.Pt = function(e, t) {
        var n = new b(e[w.FIELDS.NAME],e[w.FIELDS.TYPE],e[w.FIELDS.CATEGORY],e[w.FIELDS.OPTIONS],e[w.FIELDS.REVENUE]);
        return v.isUndefined(t) || n.setHash(t),
        n
    }
    ,
    T.Nt = function(e) {
        for (var t = C, n = [], i = 0; i < e.length; i++)
            for (var r = e[i], a = T.Pt(r[t.EVENTBASE], r[t.HASH]), o = r[t.TIMEBASE], s = r[t.TIMESTAMPS], u = 0; u < s.length; u++) {
                var c = s[u]
    ...
    t.mergeAllEvents = function(e) {
        ...
        return t.sort(R.sessionSortPredicate),
        R.sessionize(t),
        t
    }
}
    ...
    function u() {
        ...
        S(l(e)),
        T(c(B.SESSION_STATE) || {}),
        w(c(B.VISITOR_PROFILE) || {});
        var n = c(B.TRACKER_OPTIMIZELY);
        n && o(n),
        t.loadForeignData(),
    ...
    function p(e, t, i) {
        try {
            ...
            try {
                ...
                throw U.warn("Visitor / Unable to set localStorage key, error was:", e),
    ...
    function h(e) {
        ...
        if (!n)
            throw new Error("Visitor bucketingId not set");
        ...
        if (E(e, h(B.EVENT_QUEUE)))
            ...
            R.each(n, (function(e) {
                ...
                if (t) {
                    ...
                    U.debug("Attribute type", e, "not used by any audiences")
            }
            ))
        }
    }
    function m(e, t, n) {
        ...
        return R.forOwn(a, (function(e, t) {
            ...
            (n === k.AttributionTypes.FIRST_TOUCH && i >= a || n === k.AttributionTypes.LAST_TOUCH && a >= i || R.isUndefined(i) && a) && (s.data = s.data || {},
            s.data[t] = e,
            a && (s.metadata = s.metadata || {},
    ...
    function I() {
        ...
        if (n) {
            var i = R.reduce(n, (function(e, t) {
                return t.provides && (e[t.provides] = t),
                e
            }
            ), {});
    ...
    function w(e) {
        var t, n, i = K.getAllPlugins(k.PluginTypes.visitorProfileProviders), r = R.filter(i, (function(e) {
            return R.isFunction(e.restorer)
        }
        ));
        e.profile && e.metadata ? (t = e.profile,
        n = e.metadata) : (t = e,
        n = {}),
        t = R.reduce(t, (function(e, t, n) {
            var i = t
              , a = R.find(r, {
                provides: n
            });
            return a && (i = a.restorer(t)),
            e[n] = i,
            e
        }
        ), {}),
    ...
    function b(e) {
        try {
            ...
            return U.debug("Failed to parse: ", e, t),
            null
        }
    }
    var R = n(2)
      ...
      , z = V.get("stores/cookie_options")
      , j = V.get("stores/global")
      , H = V.get("stores/layer")
      , K = V.get("stores/plugins")
      , Y = V.get("stores/session")
      , q = V.get("stores/visitor_id")
      , X = V.get("stores/visitor_bucketing")
      , W = V.get("stores/visitor")
      , Q = V.get("stores/provider_status");
    ...
    t.getCurrentId = function() {
        return P.get(k.COOKIES.VISITOR_ID)
    }
    ,
    ...
    t.setId = function(e) {
        ...
        q.getBucketingId() !== n && u();
        try {
            t.maybePersistVisitorId(e)
        } catch (e) {
            if (U.error("Visitor / Unable to persist visitorId, disabling tracking"),
            D.dispatch(O.LOAD_DIRECTIVE, {
                trackingDisabled: !0
            }),
            e instanceof P.MismatchError)
                throw U.error("Visitor / Cookie not set to correct value:", e),
    ...
    t.getUserIdFromKey = function(e, n) {
        var i;
        return R.includes(e, n) && R.includes(e, "_") && R.includes(e, "$$") && R.includes(e.slice(e.indexOf("$$")), t.getNamespace()) && (i = e.slice(e.indexOf("_") + 1, e.indexOf("$$"))),
        i
    }
    ,
    t.maybePersistVisitorId = function(e) {
        P.remove(k.COOKIES.VISITOR_UUID),
        e.randomId && (z.getAutoRefresh() || t.getCurrentId() !== e.randomId ? (P.set(k.COOKIES.VISITOR_ID, e.randomId),
        U.log("Persisting visitorId:", e.randomId)) : U.log("Not persisting visitorId: value is not changed and also auto-refresh is disabled"))
    }
    ,
    ...
    t.getStorageKeyFromKey = function(e) {
        var t, n = e.split("$$").pop(), i = n.indexOf("://") > -1;
        if (i) {
            var r = n.indexOf("_");
            t = n.substring(r + 1)
        } else
            t = n;
        return R.includes(R.values(k.AllStorageKeys), t) ? t : null
    }
    ,
    ...
    t.removeLegacySessionStateCookies = function() {
        ...
        R.forEach(R.keys(e), (function(e) {
            0 === e.indexOf(k.COOKIES.SESSION_STATE + "$$") && P.remove(e)
        }
        ))
    }
}
    ...
    function i(e, n) {
        ...
        return d.dispatch(c.SET_COOKIE_DOMAIN, u),
        u
    }
    var r = n(2)
      , a = n(75).create
    ...
    t.getAll = function(e) {
        ...
        for (a = 0; a < n.length; a++)
            if (i = n[a],
            o = i.indexOf("="),
            o > 0 && (u = t.safeDecodeURIComponent(i.substring(0, o)),
            void 0 === c[u])) {
                var l = i.substring(o + 1);
                e && (l = t.safeDecodeURIComponent(l)),
                c[u] = l
            }
        return c
    }
    ...
    t.set = function(e, n, a, c) {
        ...
        if (r.isUndefined(a.domain)) {
            ...
            d || (d = i(u.getLocation(), !0)),
            a.domain = d
        }
        if (a.domain && l.push("domain=" + a.domain),
        ...
        if (r.isUndefined(a.expires) || l.push("expires=" + a.expires.toUTCString()),
        a.secure && l.push("secure"),
        l = l.join(";"),
        s.setCookie(e + "=" + (a.encodeValue ? encodeURIComponent(n) : n) + ";" + l),
        c) {
            var v = a.encodeValue
              , _ = t.get(e, v);
            if (_ !== n) {
                if (!_)
                    throw new g('Failed to set cookie "' + e + '"');
    ...
    function i(e, t) {
        ...
        return n.prototype = new (t || Error),
    ...
    var i, r, a = "optimizely_data", o = n(75).create, s = n(81), u = n(39), c = t.Error = o("StorageError");
    try {
    ...
    if (!r)
        throw new c("localStorage is undefined");
    i = s.create(r, a),
    t.LocalStorage = i,
    ...
    function i(e) {
        ...
        if ("ERROR" === t.type)
            l.dispatch(u.XDOMAIN_SET_DISABLED, {
                disabled: !0
            }),
            d.emitInternalError(new y("Xdomain Error: " + t.response));
        else if ("SYNC" === t.type)
            o.each(I.getSubscribers(), (function(e) {
            ...
            if (!n) {
                if (E.warn("XDomain", "No stored message found for ID", t.id),
                o.isNumber(t.id)) {
    ...
    t.loadIframe = function(e, t) {
        return new s(function(n) {
            ...
            i.onload = function() {
                ...
                l.dispatch(u.XDOMAIN_ADD_FRAME, r),
                n(r)
            }
            ,
    ...
    t.load = function(e, n) {
        ...
        return v.pollFor(r).then(s).then((function(e) {
            ...
            I.isDisabled() || o.each(I.getMessages(), (function(t) {
                t.startTime || a(t, e)
            }
            ))
        }
    ...
    t.on = function(e) {
        return e.token || (e.token = r.generate()),
    ...
    t.emit = function(e, t, n) {
        ...
        i.each(r, (function(i) {
            try {
                ...
                !n && i.emitErrors ? (c.error("Error in handler for event:", e, r),
                o.emitError(r, null, t)) : c.warn("Suppressed error in handler for event:", e, r)
            }
        }
        ))
    }
    ...
    t.pollFor = function(e, t, n) {
        var u, c;
        return i.isFunction(n) ? c = n : (u = n || o,
        c = function() {
            return u--,
            u < -1
        }
    ...
    function i(e, n) {
        var i;
        i = t.isInSameSession(e, n) ? e.getValueOrDefault([s.FIELDS.SESSION_ID]) : n.getValueOrDefault([s.FIELDS.TIME]),
    ...
    t.updateSessionId = function(e, t) {
        if (!e)
            return void t.setFieldValue(s.FIELDS.SESSION_ID, t.getValueOrDefault([s.FIELDS.TIME]));
    ...
    t.updateSessionIndex = function(e, t) {
        if (!e)
            return void t.setFieldValue(s.FIELDS.SESSION_INDEX, 0);
        var n = e.getValueOrDefault([s.FIELDS.TIME])
    ...
    t.reindexIfNecessary = function(e, t, n) {
        ...
        e.getValueOrDefault([s.FIELDS.SESSION_INDEX]) === -1 && (i(t),
        i(n))
    }
    ,
    ...
    t.request = function(e) {
        ...
        new c(function(n, r) {
            if (!t.isCORSSupported())
                return r("CORS is not supported");
    ...
    t.retryableRequest = function(e, n, s, l) {
        if (!n)
            return c.reject(new Error("No id specified for request."));
        if (!t.isCORSSupported())
        ...
        t.request(e).then((function(e) {
            ...
            u.warn("Event ", f, " could not be sent after ", l, " attempts.")) : (f.retryCount++,
            o.dispatch(r.SET_PENDING_EVENT, f),
            u.debug("Event ", f, " failed to send, with error ", e, " It will be retried ", l - s, " times.")),
            e
        }
        ))
    }
    ...
    t.push = function(e, t) {
        ...
        if (!i.isArray(e) && i.isObject(e))
            s = i.isUndefined(e.version) ? 1 : e.version,
            n = e.type,
            o = [e];
        else if (i.isArray(e))
            s = 0,
            ...
            if (!i.isString(e))
                return r.warn("API / Ignoring non-array/object/string argument:", e),
                !1;
            s = 0,
            n = e,
            o = []
        ...
        if (d[s] && (a = d[s][n]),
        t && f.indexOf(n) === -1)
            return r.debug("API / Ignoring non high priority function:", n, o),
            !1;
        if (!a)
            return r.warn('API / No function found for "' + n + '" (v' + s + ") with arguments:", o),
            !1;
    ...
    t.get = function(e) {
        ...
        var t = a[e];
        return t ? i.isArray(t) && (t = o.evaluate(t)) : t = s.getPlugin(c.PluginTypes.apiModules, e),
        t ? (l.dispatch(u.RECORD_API_USAGE, {
            methodName: "get." + e
        }),
    ...
    function a(e, t, n, i) {
        var r, a, s = e.layerId, u = t.get(s) || {}, c = o.map(u.experiments, (function(e) {
        ...
        if (i || !u.decisionMetadata || !u.decisionMetadata.offerConsistency) {
            ...
            r && e.decision.variationId && (a = o.find(r.variations, {
            ...
            return l.audiences = d,
            u.decisionMetadata && u.decisionMetadata.offerConsistency && (l.pageId = e.pageId),
            l
        }
    }
    var o = n(2)
    ...
    t.data = ["stores/audience_data", "stores/event_data", "stores/layer_data", "stores/view_data", "stores/group_data", "stores/interest_group", "stores/tag_group", "stores/global", function(e, t, n, i, r, a, u, d) {
        ...
        return o.each(n.getAll(), (function(e) {
            c.defineProperty(f, e.id, (function() {
                ...
                c.defineProperty(t, "experiments", (function() {
            ...
            o.each(e.experiments, (function(e) {
                c.defineProperty(g, e.id, (function() {
                    ...
                    c.defineProperty(t, "variations", (function() {
    ...
    t.state = ["stores/audience_data", "stores/layer_data", "stores/layer", "stores/view_data", "stores/view", "stores/global", "stores/observed_redirect", function(e, t, n, a, s, c, l) {
        return {
            ...
            getPageStates: function(e) {
                var t = s.getAll()
                  , n = o.reduce(t, (function(e, t) {
                    var n = a.get(t.id);
                    return e[t.id] = o.extend({}, o.pick(n, ["id", "name", "apiName", "category", "staticConditions", "tags"]), o.pick(t, ["isActive", "metadata"])),
                    e
                }
                ), {});
            ...
            getRedirectInfo: function() {
                ...
                return e && (e.referrer = f.getReferrer()),
                e
            },
    ...
    t.utils = n(99).create(),
    t.jquery = ["env/jquery", function(e) {
        return e
    }
    ],
    ...
    function o(e, n, i, r, a, o) {
        if (!v.isSingleExperimentPolicy(e.policy) || !r) {
            ...
            v.isSingleExperimentPolicy(e.policy) || (d.unshift(c.names.layer),
            g.unshift(c.idStrings.layer));
            ...
            if (s && (m += f.length),
            m > a)
                throw new Error("The analytics string size is too low to send the entity IDs.");
            for (var E = a - m, I = d.length, y = [], S = d.length - 1; S >= 0; S--) {
                var T = d[S]
                  , A = Math.min(T.length, Math.floor(E / I));
                E -= A,
                I--,
                y.unshift(T.substring(0, A))
            }
    ...
    function s(e, n, i, r, a, o) {
        ...
        if (_ + c + s.length > a)
            throw new Error("The analytics string size is too low to send the campaign, experiment, and variation IDs.");
        var m = a - _ - c - s.length
          , E = {};
        E.variation = Math.min(p.variation.length, Math.floor(m / 3)),
        m -= E.variation,
        E.experiment = Math.min(p.experiment.length, Math.floor(m / 2)),
        m -= E.experiment,
        E.layer = m;
        var I = {};
        ...
        var y = [];
        return v.isSingleExperimentPolicy(e.policy) || y.push(I.layer + h.layer),
        y = y.concat([I.experiment + h.experiment, I.variation + h.variation, s]),
        y.join(l)
    }
    var u = n(2)
      , c = n(16)
    ...
    t.formatNamesAndIdsForAnalytics = function(e, t, n, o) {
        ...
        if (o && (s = u.mapValues(s, i)),
        s.experiment === p && (!e.integrationStringVersion || 1 === e.integrationStringVersion))
            if (r(t.audienceIds))
                s.experiment = "Exp";
            else {
    ...
    t.combineAndTruncateIdAndName = function(e, t, n) {
        var i = n - t.length;
        if (i < 0 && (h.warn("maxLength must be at least long enough to fit the entity ID, which is length" + t.length + ". Defaulting to only use entity ID as name."),
        e = p),
        e === p)
            return t;
        if (e.length > i) {
    ...
    t.defineProperty = function(e, t, n, s, u) {
        i(e, t, (function() {
            ...
            return o.debug('Evaluating getter: "' + e + '"'),
            a.dispatch(r.RECORD_API_USAGE, {
                methodName: e
            }),
            n()
        }
    ...
    function i(e) {
        var n = r.cloneDeep(e);
        return n.changes && (n.changes = r.map(n.changes, t.dereferenceChangeId)),
        n.experiments && r.each(n.experiments, (function(e) {
            e.changes && (e.changes = r.map(e.changes, t.dereferenceChangeId)),
            e.variations && r.each(e.variations, (function(e) {
    ...
    t.translateLayerEventToCampaignEvent = function(e) {
        ...
        t.decision = this.translateDecisionToCampaignDecision(e.data.decision),
    ...
    function a(e) {
        if (m[e]) {
            if (o(m[e]))
                return 0 === m[e].matchedCount && l.isFunction(m[e].options.onTimeout) && m[e].options.onTimeout(),
                void r(e);
    ...
    function o(e) {
        ...
        if (null !== t)
            ...
            else if (Date.now() - e.startTime > t)
                return !0;
        return !1
    }
    function s(e) {
    ...
    t.observeSelector = function(e, t, n) {
        if (!c(e))
            throw new Error("observeSelector expects a valid css selector as its first argument");
        if (!l.isFunction(t))
    ...
    function r(e, t) {
        l[t] && l[t].callbacks[e] && (delete l[t].callbacks[e],
        a.some(l[t].callbacks) || (clearInterval(l[t].id),
        delete l[t]))
    }
    var a = n(2)
      , o = (n(7),
    ...
    function i(e) {
        ...
        if (e)
            if (r(e))
                ...
                "revenue"in n) {
                    if (!r(n["revenue"]))
                        throw new Error("tracker","Revenue value",n["revenue"],"not a number.");
                    t = Number(n["revenue"]),
                    delete n["revenue"]
                }
            }
        return a.isUndefined(t) || (n.revenue = t),
        n
    }
    function r(e) {
    ...
    t.bucketUser = t.bucketVisitor = function(e, t) {
        if (e && t) {
            ...
            t > 256 ? n.variationId = String(t) : n.variationIndex = String(t),
            o.bucketVisitor(n)
        }
    }
    ,
    ...
    function i(e) {
        var t;
        return e.eventId && (t = E.create(e.eventId, e.eventName, "custom")),
        b.updateAllViewTags(),
        function() {
    ...
    function a(e) {
        ...
        return function() {
            T.recordLayerDecision(n.layerId, n.decisionTicket, n.decision),
            A.log("API / Tracking decision event:", n),
            g.trackDecisionEvent(n.decision, n.decisionTicket, i)
        }
    }
    function o(e) {
    ...
    t.event = function(e) {
        ...
        P.getBucketingId() ? t() : y.dispatch(u.ADD_CLEANUP_FN, {
    ...
    t.page = function(e) {
        ...
        if (!t)
            throw new Error('Unknown page "' + e.pageName + '"');
        var n = !e.hasOwnProperty("isActive") || e.isActive
          , i = function() {
            n ? b.activateViaAPI(t, e.tags) : (b.deactivate(t),
            A.log("API / Deactivated Page", b.description(t)))
        };
        P.getBucketingId() ? i() : y.dispatch(u.ADD_CLEANUP_FN, {
    ...
    ,
    t.user = function(e) {
        k && e.visitorId && (A.log("API / Setting visitor Id:", e.visitorId),
        R.setId({
            randomId: e.visitorId
        })),
        A.log("API / Setting visitor attributes:", e.attributes),
        s.each(e.attributes, (function(e, t) {
            var n, i = t, r = N.getById(t) || N.getByApiName(t);
            r && (i = r.id,
            n = r.segmentId || r.id);
            var a = function() {
            ...
            P.getBucketingId() ? a() : y.dispatch(u.ADD_CLEANUP_FN, {
    ...
    t.cookieExpiration = function(e) {
        ...
        t < F && (A.error('Argument "cookieExpirationDays"=', t, "less than minimum days:", F, ", setting to minimum."),
        t = F),
        A.log("API / Setting cookie age to", t, "days."),
        y.dispatch(u.SET_COOKIE_AGE, t * x)
    }
    ,
    t.extendCookieLifetime = function(e) {
        ...
        A.log("API / Setting cookie automatic lifetime extension to", e.isEnabled),
        y.dispatch(u.SET_COOKIE_AUTO_REFRESH, e.isEnabled)
    }
    ,
    t.cookieDomain = function(e) {
        A.log("API / Setting cookie domain to", e.cookieDomain),
        y.dispatch(u.SET_COOKIE_DOMAIN, e.cookieDomain)
    }
    ,
    t.disable = function(e) {
        if (e.scope) {
            ...
            A.log("API / Disabling tracking"),
            y.dispatch(u.LOAD_DIRECTIVE, {
                trackingDisabled: !0
            })
        } else
            A.log("API / Disabling everything"),
            y.dispatch(u.LOAD_DIRECTIVE, {
                disabled: !0
            })
    }
    ...
    t.registerModule = function(e) {
        ...
        if (l[t] || c.get(t))
            throw new Error('Module name "' + t + '" is reserved. Will not be registered as plugin.');
        w.registerApiModule(t, e.module)
    }
    ,
    t.dataFromSource = function(e) {
        var t = e.source;
        h.makeAsyncRequest(t),
        h.resolveRequest(t, e.data)
    }
    ,
    ...
    t.bucketVisitor = function(e) {
        if (!e.variationId && s.isUndefined(e.variationIndex) || e.variationId && e.variationIndex)
        ...
        } else if (t = L.getLayerByExperimentId(e.experimentId),
        i = t.id,
        !i)
            throw new Error("Could not find layer for experiment " + e.experimentId);
        if (n = s.find(t.experiments, {
            id: e.experimentId
        }),
        !n)
            throw new Error("Could not find experiment " + e.experimentId + " in layer " + i);
        var r = e.variationId;
        ...
        } else if (r = n.variations[e.variationIndex].id,
        !r)
            throw new Error("Could not find variation at index " + e.variationIndex + " in experiment " + e.experimentId);
        R.updateVariationIdMap(i, e.experimentId, r),
        P.getBucketingId() && R.persistVariationIdMap()
    }
    ,
    t.waitForOriginSync = function(e) {
        if (!s.isArray(e.canonicalOrigins))
            throw new Error("canonicalOrigins must be an array. Got: " + S.stringify(e.canonicalOrigins));
        s.each(e.canonicalOrigins, (function(e) {
            if (!s.isString(e))
                throw new Error("Each item in canonicalOrigins must be a string. Found type " + typeof e)
        }
        )),
    ...
    t.disableCrossOrigin = function() {
        A.log("API / cross origin tracking is DISABLED"),
        y.dispatch(u.XDOMAIN_SET_DISABLED, {
            disabled: !0
        })
    }
    ,
    t.activate = function() {
        V.shouldActivate() ? p.emitActivateEvent() : A.debug("Not activating.")
    }
    ,
    ...
    function v(e, t, n) {
        var i = _(e, n);
        k.debug("Found " + i.length + " analytics integrations defining a " + e + " hook"),
    ...
    function m(e, t, n) {
        var i = E(e, t);
        k.debug("Found " + i.length + " analytics integrations  defining a trackLayerDecision " + e + " timing of " + t.join("|")),
    ...
    n(12).Promise)
      ...
      , X = b.get("stores/observed_redirect")
      , W = b.get("stores/pending_redirect")
    ...
    t.trackCustomEvent = function(e, t, n) {
        ...
        if (I.isUndefined(t.revenue) || (r.revenue = t.revenue),
        S.emitAnalyticsEvent({
    ...
    t.trackDecisionEvent = function(e, t, n) {
        ...
        if (!$.shouldSendTrackingData())
            return void k.log("Analytics / Not tracking decision for Campaign", V.description(n));
    ...
    t.trackPostRedirectDecisionEvent = function() {
        ...
        if (n.timing = i,
        m(i, [G.PostRedirectPolicies.TRACK_IMMEDIATELY], n),
        te) {
            ...
            return x.race([r, a]).then((function() {
                ...
                t = Q.getVisitorProfile(),
                n = l(e, !1, t),
                n.timing = G.TrackLayerDecisionTimingFlags.postRedirectPolicy,
                m(G.TrackLayerDecisionTimingFlags.postRedirectPolicy, [G.PostRedirectPolicies.TRACK_AFTER_SYNC], n),
                L.dispatch(y.REGISTER_TRACKED_REDIRECT_DATA)
            }
            ))["catch"]((function(e) {
        ...
        return m(G.TrackLayerDecisionTimingFlags.postRedirectPolicy, [G.PostRedirectPolicies.TRACK_AFTER_SYNC], n),
        L.dispatch(y.REGISTER_TRACKED_REDIRECT_DATA),
        x.resolve()
    }
    ,
    ...
    t.trackViewActivation = function(e, t) {
        ...
        $.shouldSendTrackingData() ? (T.addEvent(i),
        L.dispatch(y.TRACK_VIEW_ACTIVATED_EVENT, {
            pageId: e.id,
            eventData: n
        }),
        v("onPageActivated", n),
    ...
    function i(e) {
        try {
            ...
            return _.error("Relay / Error computing redirect relay cookie: ", e),
            void g.emitError(e)
        }
        ...
        var t = []
          , n = l.reduce(e, (function(e, n, i) {
            ...
            return r ? (r.isMulti ? l.forEach(n, (function(t, n) {
                t = r.valueToValueString ? r.valueToValueString(t, n) : String(t),
                l.isNull(t) || (t = (r.encodeValueString || encodeURIComponent)(t),
                e.push(encodeURIComponent(r.relayName + I + n) + "=" + t))
            }
            )) : l.isNull(n) || (n = (r.valueToValueString || String)(n),
    ...
    function o(e) {
        ...
        return l.forEach(n, (function(e) {
            ...
            !r))
                return void _.warn("Relay / Skipping segment with unknown field identifier:", e, i);
            var a = n[1];
            try {
                if (r.isMulti) {
                    t[r.name] = t[r.name] || {};
                    ...
                    a = (r.decodeValueString || f.safeDecodeURIComponent)(a),
                    a = (r.valueFromValueString || l.identity)(a),
                    t[r.name] = a
            } catch (t) {
                return _.warn("Relay / Skipping segment due to decode or parse error:", e, t),
                void g.emitError(t)
            }
        }
        )),
    ...
    t.load = function() {
        ...
        e) {
            ...
            return l.forEach(y, (function(n) {
                (l.isNull(e[n.name]) || l.isUndefined(e[n.name])) && (n.isNullable ? e[n.name] = null : (delete e[n.name],
                t.push(n.name)))
            }
            )),
            t.length ? void _.error("Relay / Observed redirect data with missing fields:", t) : (v.dispatch(d.LOAD_REDIRECT_DATA, e),
    ...
    function a() {
        ...
        if (!E.isString(e))
            return void b.warn("Directive / userAgent not a string");
        e = e.toLowerCase();
        var t = ["googlebot", "yahoo! slurp", "bingbot", "bingpreview", "msnbot", "keynote", "ktxn", "khte", "gomezagent", "alertsite", "yottaamonitor", "pingdom.com_bot", "aihitbot", "baiduspider", "adsbot-google", "mediapartners-google", "applebot", "catchpoint", "phantomjs", "moatbot", "facebookexternalhit"]
          , n = function(t) {
            if (E.includes(e, t))
                return b.warn("Directive / Matches bot:", t),
                !0
        };
        E.some(t, n) && (b.log("Directive / Disabling tracking"),
        w.dispatch(I.LOAD_DIRECTIVE, {
            trackingDisabled: !0
        }))
    }
    ...
    function s() {
        ...
        for (var n = 0; n < t.length; n++)
            if ("true" === D.getQueryParamValue(t[n])) {
                b.warn("Directive / Not activating because " + t[n] + " is set."),
                e = !0;
                break
            }
        w.dispatch(I.LOAD_DIRECTIVE, {
    ...
    function c() {
        ...
        e && b.log("Directive / Is legacy preview mode"),
        w.dispatch(I.LOAD_DIRECTIVE, {
            isLegacyPreview: !!e
        })
    }
    ...
    function f() {
        ...
        t && b.log("Directive / Is running in desktop app editor"),
        w.dispatch(I.LOAD_DIRECTIVE, {
    ...
    function g() {
        ...
        e && b.log("Directive / Is running in editor"),
        w.dispatch(I.LOAD_DIRECTIVE, {
    ...
    function h() {
        ...
        if (n)
            t = S.safeDecodeURIComponent(n).split(",");
        else if (e)
            try {
                var i = O.parse(e);
        ...
        t.length && (b.log("Directive / Force Audience IDs:", t),
        w.dispatch(I.LOAD_DIRECTIVE, {
            forceAudienceIds: t
        }))
    }
    function v() {
        ...
        t.length && (b.log("Directive / Force Variation IDs:", t),
        w.dispatch(I.LOAD_DIRECTIVE, {
            forceVariationIds: t
        }))
    }
    ...
    function m() {
        ...
        if (t) {
            ...
            "undefined" != typeof n[1] && b.setLogMatch(n[1])
        }
        b.setLogLevel(e)
    }
    var E = n(2)
    ...
    t.setOptOut = function(e) {
        e ? (b.warn("Directive / Opting out"),
        S.set(A.COOKIES.OPT_OUT, "true", {
            maxAge: 10 * P
        }, !0)) : S.remove(A.COOKIES.OPT_OUT),
        w.dispatch(I.LOAD_DIRECTIVE, {
            shouldOptOut: e
        })
    }
    ...
    t.getQueryParams = function() {
        ...
        if (0 === e.indexOf("?") && (e = e.substring(1)),
        0 === e.length)
            return [];
    ...
    t.registerAudiencePlugin = function(e) {
        ...
        n = i.isString(e.provider) ? a.get(e.provider)(e.vendor) : i.isFunction(e.provider) ? e.provider(e.vendor) : i.cloneDeep(e.provider),
        t.registerVisitorProfileProvider(i.extend(n, {
            provides: r
        }));
        var o;
    ...
    t.activateViaAPI = function(e, n) {
        n && t.setUserSuppliedViewTags(e.id, n),
        t.activateMultiple([e], n)
    }
    ,
        ...
        r.each(e, (function(e) {
            ...
            if (r.isActive)
                if (e.deactivationEnabled)
                    ...
                    g.log("Not activating Page, already active ", t.description(e));
            else {
                try {
                    if (!t.hasValidStaticConditions(e, s))
                        return void g.log("Page / Failed to match page conditions for " + t.description(e), e.staticConditions)
                } catch (n) {
                    return void g.error("Page / Error evaluating whether to activate page ", t.description(e), n)
                }
                a.push(e),
                t.setViewActiveState(e, !0),
                g.log("Activated Page", t.description(e)),
                o.emitViewActivated({
                    view: e,
                    metadata: n
                });
    ...
    t.deactivate = function(e) {
        ...
        if (!n.isActive)
            return void g.log("Not deactivating Page, already inactive ", t.description(e));
        t.setViewActiveState(e, !1),
        g.log("Deactivated Page", t.description(e)),
    ...
    t.hasValidStaticConditions = function(e, t) {
        if (r.isEmpty(e.staticConditions))
            return !0;
        var n = h.getAllPlugins(l.PluginTypes.viewMatchers);
        g.groupCollapsed("Page / Evaluating staticConditions:", e.staticConditions),
        g.debug("Matching to current value:", t);
        var i = s.evaluate(e.staticConditions, (function(e) {
            var i = e.type
              , r = n[i];
            if (!r)
                throw new Error("Page / No matcher found for type=" + i);
            return r.match(t, e)
        }
        ));
        return g.groupEnd(),
    ...
    function o(e, t) {
        ...
        if (s.isArray(e)) {
            ...
            r = e.slice(1)) : (i = l.OR,
            r = e),
            c.groupCollapsed('Condition / Applying operator "' + i + '" with args', u.stringify(r));
            try {
                n = d[i](r, t),
                c.debug("Condition / Result:", n)
            } finally {
                c.groupEnd()
            }
            return n
        ...
        return n = t(e),
        c.debug("Condition / Evaluated:", u.stringify(e), ":", n),
        n
    }
    var s = n(2)
      , u = n(26)
    ...
    t.getTagValue = function(e) {
        ...
        if (!n)
            throw new t.Error("No locator registered for tag locatorType: " + e.locatorType);
        return n(e)
    }
    ,
    t.enums = n(125),
    ...
    t.addScriptSync = function(e, n) {
        try {
            ...
            if (!s)
                throw new Error("Document.write failed to append script");
            s.onload = n,
            ...
            return a.request({
                ...
                r.error("Failed to load " + e + " via synchronous XHR: " + i.message),
                t.addScriptAsync(e, n)
            }
            ))
        }
    ...
    function i() {
        var e = null;
        A.isNumber(e) && 0 === pe.getCount() ? (q.log("Activating after delay of", e, "ms because no Experiments are running"),
        j.dispatch(D.SET_RUM_DATA, {
            data: {
                activateDfd: !0
            }
        }),
        ae.setTimeout(N.emitActivateEvent, e)) : N.emitActivateEvent()
    }
    function r(e) {
    ...
    function s() {
        var e = fe.getAccountId()
          , t = "https://a11179690159.cdn.optimizely.com".replace("__SUBDOMAIN__", "a" + e + ".")
          , n = "/client_storage/a" + e + ".html";
        oe.subscribe(A.bind(Y.setItem, Y));
        var i = oe.fetchAll().then((function(e) {
            var t = Te.getCanonicalOrigins();
            if (t) {
                var n = oe.getXDomainUserId(e, t);
                n && (q.log("Syncing cross-origin visitor randomId:", n),
                re.maybePersistVisitorId({
                    randomId: n
                }))
            }
            return e
          ...
          , r = !!re.getCurrentId()
          , a = !!r && re.hasSomeData();
        return r ? a ? q.log("xd / Existing visitor; has data on this origin") : q.log("xd / Existing visitor; new to this origin") : q.log("xd / New visitor"),
        J.all([oe.load(t, n)["catch"]((function(e) {
            throw q.debug("xd / Failed to load iframe:", e),
            r && !a && u(!1, e),
            e
        }
        )), i.then((function(e) {
            if (re.loadForeignData(),
            r && !a) {
                var t = !A.isEmpty(e);
                q.debug("xd / Loaded foreign data? ", t),
                u(t)
            }
        }
        ), (function(e) {
            throw r && !a && (q.debug("xd / Failed to load foreign data:", e),
            u(!1, e)),
            e
        }
        )).then((function() {
            q.log("Loaded visitor data from foreign origins"),
            N.emitOriginsSyncedEvent()
        }
        ), (function(e) {
            q.debug("xd / Ignored error syncing foreign data (expected if waitForOriginSync used:", e.message),
            q.debug("xd / Enqueuing sync to happen after visitorId set."),
            j.dispatch(D.ADD_CLEANUP_FN, {
    ...
    function l(e, t, n) {
        ...
        return t && n && x.isPageIdRelevant(t) ? A.map(n, (function(e) {
            return x.createTicket(A.extend({}, l, {
                pageId: e
            }))
        }
        )) : [x.createTicket(l)]
    ...
    function f(e) {
        var t = pe.getAllByPageIds(e)
          ...
          , r = A.reduce(t, (function(e, t) {
            return t.groupId ? e.groups[t.groupId] || (e.groups[t.groupId] = ge.get(t.groupId)) : e.individual.push(t),
            e
        }
        ), {
            groups: {},
        ...
        q.log("Groups:", a);
        var o = A.map(r.individual, K.description).join(", ");
        q.log("Campaigns/Experiments not in Groups (by Campaign id):", o);
        var s = A.map(r.groups, A.partial(g, n, i, e)) || []
        ...
        return J.all(c).then((function(t) {
            ...
            return q.log("All Campaigns/Experiments for Page(s) (by Campaign id)", e, "resolved:", A.map(n, K.description).join(", ")),
            n
        }
        ))
    }
    function g(e, n, i, r) {
        try {
            var a = d(r)
              , o = x.decideGroup(r, a);
            if (o.reason)
                return q.debug("Not activating Group", H.description(r), "; reason:", o.reason),
                J.resolve();
            var s = pe.get(o.layerId);
            if (!s)
                return q.debug("Visitor was bucketed into a Campaign (" + o.layerId + ") which is not in this snippet"),
                J.resolve();
            var u = A.filter(s.pageIds, A.partial(A.includes, i));
            return A.isEmpty(u) ? (q.debug("Not activating Group", H.description(r), "; reason: visitor was bucketed into a Campaign/Experiment not related to the currently-activating Page(s)"),
            J.resolve()) : t.decideAndExecuteLayerASAP(e, n, u, s)
        } catch (e) {
            return q.error("Error getting decision for Group", H.description(r), "; ", e),
            J.reject(e)
        }
    }
    function p(e, t, n, i) {
            ...
            try {
                v(i, e, t, n, (function(a) {
                    A.each(a, (function(r) {
                        ...
                        q.debug("Deciding layer: ", i, "with decisionTicket: ", r, "and actionViewIds: ", a),
                        h(i, e, t, a, r)
                    }
                    )),
                    r(i)
                ...
                q.error("Error getting decision for Campaign: " + K.description(i), e),
                a(e)
            }
        }
        )
    ...
    function h(e, t, n, i, r) {
        ...
        q.log("Activating Campaign", a, "on Page(s)", i),
        n.length && (q.log("Applying force audienceIds:", n, "to Campaign", a),
        r = A.cloneDeep(r),
        r.audienceIds = n);
        var o = I(e, r, t)
          , s = !(!t.length && !n.length)
          , u = S(e, o, s) || [];
        T(u, i);
        if (q.warn("Not preparing actions because LIVE_CHANGES is false"),
        A.forEach(i, (function() {
            O.trackDecisionEvent(o, r)
        }
        )),
        N.emitLayerDecided({
            layer: e,
        ...
        o.error)
            throw o.error;
        return x.isInCohort(o) ? void q.warn("Not executing actions because LIVE_CHANGES is false") : void q.log("Not activating Campaign: " + K.description(e) + "; not in the cohort because:", o.reason)
    }
    function v(e, t, n, i, r) {
        if (t.length || n.length)
            return void r(l([], void 0, i));
    ...
    function _(e, t, n) {
        var i = A.map(e.audienceIds, A.bind(ue.get, ue))
          , r = A.filter(t, (function(t) {
            return !A.includes(e.audienceIds, t.id)
        }
        ));
        q.log("When deciding Campaign", K.description(n), "visitor is in audiences:", m(i), "and not in audiences:", m(r))
    }
    function m(e) {
        var t = [];
    ...
    function E(e, t, n) {
        var i = _e.getAllPlugins(U.PluginTypes.audienceMatchers)
          , r = A.reduce(e, (function(e, t) {
            return A.extend(e, C.requiredAudienceFieldsForConditions(t.conditions, i))
        }
        ), {})
          , a = A.reduce(r, (function(e, t) {
            if (A.isUndefined(re.getAttribute(t))) {
                var n = re.getPendingAttributeValue(t);
                A.isUndefined(n) || e.push(n)
            }
            return e
        }
        ), []);
          ...
          , s = Z.firstToResolve(A.map(a, (function(e) {
            return J.resolve(e).then((function() {
                ...
                if (o = A.filter(o, (function(t) {
                    return A.isUndefined(C.isInAudience(e, t, i))
                }
                )),
                !A.isEmpty(o))
        ...
        J.race([s, new J(function(e, n) {
            ...
            q.log("Activating Campaign after pending Audiences resolved", e),
            n()
        }
        ), (function() {
            q.log("Activating Campaign after timeout on Audiences", e),
            n()
        }
        ))
    }
    function I(e, t, n) {
        ...
        return i = n.length ? x.getDummyLayerDecision(e, n) : x.decideLayer(e, t),
        q.log("Recording decision for Campaign", r, t, "->", i),
        K.recordLayerDecision(e.id, t, i),
        i.variationId && i.experimentId && re.updateVariationIdMap(e.id, i.experimentId, i.variationId),
        e.groupId && re.updatePreferredLayerMap(e.groupId, e.id),
        i
    }
    function y(e) {
    ...
    function S(e, t, n) {
        ...
        if (!n && fe.isGlobalHoldback())
            return q.log(r, i, "(visitor is in global holdback)"),
            null;
        if (t.isLayerHoldback)
            return q.log(r, i, "(visitor is in layer holdback)"),
            null;
        if (!t.experimentId || !t.variationId)
            return q.log(r, i, "(visitor is not eligible for any Experiments)"),
            null;
        ...
        return q.log("Got Actions for Campaign:", i, a),
        a
    }
    function T(e, t) {
    ...
    var A = n(2)
      , w = n(75).create
      , b = t.ActivationCodeError = w("ActivationCodeError")
      , R = t.ProjectJSError = w("ProjectJSError")
      , D = (n(133),
    n(7))
      , O = n(109)
      , N = n(116)
      ...
      , ve = F.get("stores/pending_events")
      , _e = F.get("stores/plugins")
      , me = F.get("stores/visitor")
      , Ee = F.get("stores/view_data")
      , Ie = F.get("stores/view")
      , ye = F.get("stores/visitor_id")
      , Se = F.get("stores/visitor_bucketing")
      , Te = F.get("stores/xdomain")
      , Ae = n(91)
      , we = n(146)
      , be = n(1)
      , Re = 1e3
    ...
    t.initialize = function(e) {
        var n = e.clientData;
        if (V.normalizeClientData(e.clientData),
        G.on({
            filter: {
                type: "error"
            },
        ...
        j.dispatch(D.DATA_LOADED, {
            data: n
        }),
        q.log("Initialized with DATA:", n),
        a(),
        de.isDisabled() || de.shouldOptOut())
            return void q.log("Controller / Is disabled");
        be.queueBeacons(),
        M.isReady() ? j.dispatch(D.SET_DOMCONTENTLOADED) : M.addReadyHandler((function() {
            j.dispatch(D.SET_DOMCONTENTLOADED)
        }
        ));
        var o = !1
          , s = P.get(U.COOKIES.REDIRECT);
        if (s) {
            var u = s.match(/^(\d+)\|(.*)/);
            if (u) {
        ...
        A.each(fe.getPlugins() || [], (function(e) {
            try {
                z.apply(e, [Q])
            } catch (e) {
                L.emitError(e)
        ...
        var f = G.on({
            ...
            handler: function() {
                me.observe(re.persistVisitorProfile),
                he.observe(re.persistLayerStates),
                se.observe(re.persistSessionState),
                ve.observe(X.persistPendingEvents),
        ...
        if (g && (j.dispatch(D.LOAD_PENDING_EVENTS, {
            events: g
        }),
        X.retryPendingEvents(g)),
        G.on({
            filter: {
                type: "lifecycle",
                name: "activate"
        ...
        if (Te.isDisabled())
            ...
            if (p.push(h),
            Te.getCanonicalOrigins()) {
                var v = te.makeTimeoutPromise(Oe);
                J.race([h, v])["catch"]((function(e) {
    ...
    t.activate = function() {
        try {
            var e = [];
            q.log("Activated client"),
            A.forEach(Ie.getActiveViewStates(), (function(e) {
                ie.deactivate(Ee.get(e.id))
            }
            )),
            y(U.Lifecycle.preActivate);
            var t = k.now();
            j.dispatch(D.ACTIVATE, {
                activationId: String(t),
                activationTimestamp: t
            });
            var n = Ee.getAll();
            ie.registerViews(n),
            re.setId(re.getIdFromCookies()),
            e.push(O.trackPostRedirectDecisionEvent()),
            j.dispatch(D.MERGE_VARIATION_ID_MAP, {
                variationIdMap: re.getVariationIdMap()
            }),
            j.dispatch(D.MERGE_PREFERRED_LAYER_MAP, {
                preferredLayerMap: re.getPreferredLayerMap()
            }),
            y(U.Lifecycle.postVisitorProfileLoad),
            e.push(c(_e.getAllPlugins(U.PluginTypes.visitorProfileProviders)).then((function() {
            ...
            j.dispatch(D.RECORD_GLOBAL_DECISION, r);
            var a = O.trackClientActivation();
            a ? q.log("Tracked activation event", a) : q.log("Not tracking activation event");
            var o = Ne.setUpViewActivation(n);
            return De ? ie.activateMultiple(o) : A.each(o, (function(e) {
                ie.activateMultiple([e])
            }
            )),
            y(U.Lifecycle.postViewsActivated),
            y(U.Lifecycle.postActivate),
            N.emitActivatedEvent(),
            J.all(e).then((function() {
                G.emit({
    ...
    Ne.setUpViewActivation = function(e) {
        var t = [];
        return A.each(e, (function(e) {
            ie.shouldTriggerImmediately(e.activationType) ? t.push(e) : e.activationType === U.ViewActivationTypes.callback ? (q.debug("Setting up conditional activation for Page", ie.description(e)),
            Ne.activateViewOnCallback(e)) : e.activationType === U.ViewActivationTypes.polling ? (q.debug("Setting up polling activation for Page", ie.description(e)),
            $.pollFor(A.partial(z.apply, e.activationCode), null, A.partial(ne.isTimedOut, k.now())).then((function() {
                ie.activateMultiple([e])
            }
            ))["catch"]((function(t) {
    ...
    Ne.activateViewOnCallback = function(e) {
        ...
        try {
            z.apply(e.activationCode, [t, n])
        } catch (t) {
            var i = new b("(" + t.toString() + ") in activationCode for " + ie.description(e));
            L.emitError(i, {
                originalError: t,
                userError: !0
            })
    ...
    t.onViewsActivated = function(e) {
        var t, n = e.data.views, i = A.map(n, "id");
        try {
            if (!ye.getBucketingId())
                throw new Error("View activated with no visitorId set");
            var r = f(i)["catch"](L.emitError);
            return t = J.all(A.map(n, (function(e) {
                var t = function() {
                    ie.parseViewTags(e);
                    var t = O.trackViewActivation(e);
                    t ? q.log("Tracked activation for Page", ie.description(e), t) : q.log("Not Tracking activation for Page", ie.description(e))
                };
                return M.isReady() ? J.resolve(t()) : $.pollFor(M.isReady, Re).then(t)
            }
            ))),
            J.all([r, t])
        } catch (e) {
        ...
        A.each(n, (function(e) {
            ...
            n && (A.each(n, (function(e, n) {
                if (e.cancel)
                    try {
                        e.cancel(),
                        q.debug("Controller / Canceled change", n, "observation due to deactivation of page:", t)
                    } catch (e) {
                ...
                if (t.undoOnDeactivation && e.undo)
                    try {
                        e.undo(),
                        q.debug("Controller / Undid change", n, "due to deactivation of page:", t)
                    } catch (e) {
                        q.error("Controller / Error undoing change upon deactivation of page.", e)
                    }
            }
            )),
            j.dispatch(D.REMOVE_ACTION_STATE, {
                actionId: e
            }),
    ...
    function i(e, t, n) {
        ...
        if (!i)
            return void g.warn("Action / Attempted to prepare change for inactive action: ", t);
        var r = _.getChangeApplier(e.id, t.id);
        if (!a.isUndefined(r))
            return void g.warn("Action / Attempted to prepare a change which is already being applied: ", e);
        var s = {
            changeId: e.id,
            actionId: t.id,
    ...
    function r(e, t, n, o) {
        if (a.includes(o, t))
            return void g.error("Change with id " + t + " has circular dependencies: " + o.concat(t));
        if (!e[t]) {
            var c = m.getChange(t);
            if (!c) {
                var d = "Change with id " + t + " is absent";
                return o.length && (d += " but listed as a dependency for " + o[o.length - 1]),
                void g.warn(d)
            }
            e[t] = new p(function(d) {
                ...
                if (c.src) {
                    var v = "change_" + c.src
                      , E = u.makeAsyncRequest(v, (function() {
                        return h.addScriptAsync("https://cdn.optimizely.com/public/11179690159/data" + c.src, (function() {
                            u.resolveRequest(v)
                        }
                        ))
                    }
                        ...
                        e || s.emitError(new S("Failed to load async change from src: " + c.src)),
                        i(e, n, l.now())
                    }
                    ));
                    f.push(E)
                ...
                p.all(f).then((function() {
                    ...
                    return i ? (g.debug("Action / Applying change:", c),
                    i.apply().then((function(t) {
                        t ? g.log(t) : g.debug("Action / Applied change for the first time in " + (l.now() - e) + "ms:", c),
                        d()
                    }
                    ))) : (g.debug("Action / Not applying change ", t, " - No changeApplier found."),
                    void d())
                }
                ))["catch"]((function(e) {
                    g.error("Action / Failed to apply change:", c, e),
                    d()
                }
                ))
            }
    ...
    t.create = function(e, t, n) {
        ...
        try {
            ...
            if (!c)
                throw new Error("Unrecognized change type " + e.type);
            return new c(e,a)
        } catch (e) {
    ...
    t.initialize = function() {
        i(),
        document.addEventListener("readystatechange", i, !0)
    }
    ,
    t.isTimedOut = function(e) {
        ...
        return a.isEditor() && (i = t.domReadyTime),
    ...
    function i(e, t) {
        return function(n) {
            var i = n.type
              , a = t[i];
            if (!a)
                throw new Error("Audience / No matcher found for type=" + i);
            if (a.fieldsNeeded)
                for (var s = r(a.fieldsNeeded, n), l = 0; l < s.length; l++) {
                    var d = s[l]
                      , f = u.getFieldValue(e, d);
                    if (o.isUndefined(f))
                        return void c.debug("Audience / Required field", d, "for type", i, "has no value")
                }
    ...
    function r(e, t) {
        ...
        return o.isString(n) && (n = [n]),
        o.isArray(n) ? n : (c.warn("Couldn't determine fieldsNeeded for matcher; assuming []"),
        [])
    }
    function a(e) {
    ...
    function i(e, t) {
        ...
        var n, i, r = t.preferredLayerId, a = !!r;
        if (a)
            _.debug("Decision / Using preferredLayerMap to select layer for group:", h.description(e)),
            n = r;
        else
            try {
                n = l.chooseWeightedCandidate(t.bucketingId, e.id, e.weightDistributions),
                n && "None" !== n || (i = 'Group traffic allocation. Visitor maps to a "hole" in the bucket space left by an experiment or campaign that\'s since been removed from the group')
            } catch (e) {
    ...
    function a(e) {
        ...
        if (s.isEmpty(t))
            throw new Error("No deciders found for policy: " + e);
        return t
    }
    function o(e, t) {
        var n = E.getAllPlugins(p.PluginTypes.audienceMatchers);
        return s.reduce(t, (function(t, i) {
            return c.isInAudience(e, i, n) && t.push(i.id),
            t
        }
        ), [])
    }
    ...
    t.decideLayer = function(e, t) {
        ...
        var n, i, r = a(e.policy), o = {
            layerId: e.id,
            experimentId: null,
            variationId: null,
            isLayerHoldback: l.isHoldback(t.bucketingId, e)
        };
        if (s.isEmpty(e.experiments))
            throw new f("No experiments in layer.");
        try {
            if (r.decideLayer) {
                ...
                _.debug("Decision / Using default decideLayer behavior."),
                n = r.selectExperiment(e, t.audienceIds, t.bucketingId),
                i = d.selectVariation(n, t.audienceIds, t.bucketingId, t.activationId, t.preferredVariationMap)
        } catch (e) {
            e instanceof f ? o.reason = e.message : o.error = e
        }
        return o.experimentId = n ? n.id : null,
        o.variationId = i ? i.id : null,
        o.error && (o.error.name = "DecisionEngineError",
        u.emitError(o.error)),
        o
    }
    ,
    t.getDummyLayerDecision = function(e, t) {
        var n, i = r(e, t);
        return i ? (_.log("Decision / Applying force variation:", i.variationId, "to Campaign", v.description(e)),
        n = {
            layerId: e.id,
            ...
            isLayerHoldback: !1,
            reason: "force"
        }) : (_.log("No variation matches ids:", t, "in Campaign", v.description(e)),
        n = {
            layerId: e.id,
            variationId: null,
            experimentId: null,
    ...
    t.isInCohort = function(e) {
        if (!e.experimentId || !e.variationId)
            return !1;
    ...
    t.isValidExperiment = function(e, t) {
        ...
        return s.groupCollapsed("Decision / Evaluating audiences for experiment:", t, e),
    ...
    t.selectVariation = function(e, t, n, a, c) {
        ...
        if (!e.weightDistributions && e.variations.length > 1)
            throw new o('On selected experiment "' + e.id + '", weightDistributions must be defined if # variations > 1');
        var l;
        if (e.bucketingStrategy && e.bucketingStrategy === u)
            if (1 === e.variations.length)
                l = e.variations[0].id;
            else {
                var d = a;
            ...
            if (!i.find(e.variations, {
                ...
                return s.debug("Decision / Preferred variation:", f, "not found on experiment:", e.id, ". Visitor not bucketed."),
                null;
            l = f
        } else
            l = 1 === e.variations.length ? e.variations[0].id : r.chooseWeightedCandidate(n, e.id, e.weightDistributions);
        var g = i.find(e.variations, {
            id: l
        });
        if (g)
            return s.debug("Decision / Selected variation:", g),
            g;
    ...
    t.hasVariationActionsOnView = function(e, t) {
        return s.debug("Decision / Checking variation:", e, "for actions on pageId:", t),
    ...
    exports.eval = function(str) {
        ...
        try {
            return EXEC_WITH_JQUERY && (str = "var $ = optimizely.get('jquery');" + str),
            eval(str)
        } catch (e) {
            throw Logger.warn("Error executing JS:", str, e),
            new ExecError(e)
        }
    }
}
    ...
    t.persistPendingEvents = function() {
        try {
            ...
            u.warn("PendingEvents / Unable to set localStorage key, error was: ", e),
    ...
    t.handleError = function(e, t) {
        ...
        var s = e.name || "Error"
          , p = e.message
          , h = e.stack || null;
        e instanceof a && (p instanceof Error ? (p = p.message,
        h = e.message.stack) : h = null);
        var v = {
            timestamp: o.now(),
        ...
        i.isEmpty(_) || (v.metadata = _),
        c.error("Logging error", v),
    ...
    e.exports = function(e) {
        ...
        e.registerAudienceMatcher("behavior", n(153))
    }
}
), (function(e, t, n) {
    var i = n(152);
    ...
    e.exports = {
        ...
        match: function(e, t) {
            var n = []
              , s = r.parse(t.value);
            return n = i.isUndefined(s.version) ? [s] : a.buildFromSpecV0_1(s),
    ...
    function a(e) {
        ...
        e["filter"] && (u.isArray(e["filter"]) ? u.each(e["filter"], (function(e, n) {
        ...
        var n = []
          , i = [];
        if (e["sort"] && (e["reduce"] && e["reduce"]["aggregator"] && "nth" !== e["reduce"]["aggregator"] && t.push("sort: superfluous because we can apply aggregator " + l.stringify(e["reduce"]["aggregator"]) + " to unsorted items"),
        u.isArray(e["sort"]) ? u.each(e["sort"], (function(e, r) {
            var a = s.validateFieldKeyPathV0_2(e["field"], s.FieldPurpose.SORT);
            a && t.push("sort[" + r + "]: " + a),
            e["field"] && "frequency" === e["field"][0] ? n.push(e) : i.push(e);
            var u = o(e["direction"]);
            u && t.push("sort[" + r + "]: " + u)
        }
        )) : t.push("sort: not an array"),
        n.length && i.length && t.push('sort: sorting by non-["frequency"] field is pointless because we are going to sort the picked values by ["frequency"]'),
        n.length && !e["pick"] && t.push('sort: sorting by ["frequency"] is impossible because no values have been picked')),
        e["pick"]) {
        ...
        if (e["reduce"]) {
            ...
            u.includes(["sum", "avg", "max", "min", "count", "nth"], a) || t.push("reduce: " + c + " is unknown"),
            u.includes(["sum", "avg", "max", "min"], a) && (e["pick"] || t.push("reduce: " + c + " is impossible to use because no values have been picked")),
            "nth" === a ? ((!u.isNumber(d) || isNaN(d) || parseInt(d, 10) !== d || d < 0) && t.push("reduce: " + f + " is not a non-negative integer (mandated by " + c + ")"),
            e["sort"] || t.push('reduce: aggregator "nth" is meaningless without a specific sort order')) : u.isUndefined(d) || t.push("reduce: " + f + " is defined (not mandated by " + c + ")")
        }
        if (t.length)
    ...
    s.aggregateField = function(e, t) {
        return u.isString(t) && (t = [t]),
        t = t || f.DEFAULT_FIELD,
        [f.generateAlias(e, t)]
    }
    ,
    s.groupField = function(e) {
        return u.isString(e) && (e = [e]),
        e = e || f.DEFAULT_FIELD,
        [e.join(".")]
    }
    ;
    ...
    s.rangeTimeComparison = function(e) {
        ...
        } : (d.error("Rule builder", "rangeTimeComparison passed invalid range", e),
        null)
    }
    ,
    ...
    s.getFieldKeyPathForSource = function(e, t) {
        ...
        var n = [];
        return u.isString(e) ? (n = [e],
        t !== s.SOURCE_TYPES.BEHAVIOR || u.includes(u.values(c.FIELDS), e) || (n = [c.FIELDS.OPTIONS, e])) : n = e,
        n
    }
    ,
    s.buildFromSpecV0_1 = function(e) {
        if (!(e.action || e.filters && 0 !== e.filters.length))
            throw new Error('Audience spec must have an "action" field or at least one "filter" ' + l.stringify(e));
        var t = s.fieldComparison("gt", c.FIELDS.TIME, 0)
          , n = []
          , i = [];
        if (e.action && (i.push(s.fieldComparison("eq", c.FIELDS.NAME, e.action.value)),
        e.action.type && i.push(s.fieldComparison("eq", c.FIELDS.TYPE, e.action.type))),
        e.time)
            if ("last_days" === e.time.type)
                ...
                d.error("Rule builder", 'Audience spec has bad "time" type', e.time.type);
        if (t = {
            op: "and",
            args: i
        },
        ...
        e.filters && u.each(e.filters, (function(r) {
            ...
            if (r.modifier === s.FREQUENCY_FILTERS.MOST_FREQUENT ? (a = s.aggregate("count"),
            o = s.aggregateField("count")) : r.modifier === s.RECENCY_FILTERS.MOST_RECENT && (a = s.aggregate("max", c.FIELDS.TIME),
            ...
            a) {
                ...
                i.push(s.fieldComparison(r.comparator, u, r.value))
        }
        )),
        e.pick) {
            if (n.length > 0)
                throw new Error('A "pick" clause must not be specified with "count" or "most_recent", "most_frequent" modifiers' + l.stringify(e));
    ...
    s.buildFromSpecV0_2 = function(e) {
        ...
        if (e["sort"] && (u.each(e["sort"], (function(e) {
            u.includes(["ascending", "descending"], e["direction"]) && (u.includes(["time", "age"], e["field"][0]) && i.push(e),
        ...
        e["pick"] && e["pick"]["field"]) {
            ...
            if (e["reduce"] && u.includes(["avg", "max", "min", "sum"], e["reduce"]["aggregator"]))
                return u.extend(t, {
                    aggregate: [{
    ...
    s.validateFieldKeyPathV0_2 = function(e, t) {
        ...
        if ("tags" === e[0] && e.length > 2 || "tags" !== e[0] && e.length > 1)
            return n + " includes too many strings";
        if ("tags" === e[0] && e.length < 2)
            return n + " does not specify an exact tag";
        if (e.length < 1)
            return n + " does not specify a top-level field";
        var i = u.keys(c.FIELDS_V0_2)
          , r = ["age", "frequency"];
        return t === s.FieldPurpose.FILTER && (i.push("age"),
        r = ["frequency"]),
        t === s.FieldPurpose.SORT && (i = ["time", "age", "frequency"],
        r = ["name", "type", "category", "tags"]),
        u.includes(r, e[0]) ? n + " is not supported here" : u.includes(i, e[0]) ? void 0 : n + " is unknown"
    }
    ,
    s.validateComparatorAndValue = function(e, t) {
        var n = "comparator " + (l.stringify(e) || String(e))
          , i = "value " + (l.stringify(t) || String(t));
        if (!u.isString(e) && !u.isUndefined(e))
            return n + " is not a string";
        switch (e) {
        case void 0:
        case "eq":
        case "is":
        ...
        case "in":
            ...
            break;
        case "between":
            if (!(u.isArray(t) && 2 === t.length && u.isNumber(t[0]) && u.isNumber(t[1]) && t[0] <= t[1]))
                return i + " is not a pair of increasing numbers (mandated by " + n + ")";
            break;
        case "regex":
            if (!(u.isString(t) || u.isArray(t) && 2 === t.length && u.isString(t[0]) && u.isString(t[1])))
                return i + " is not a pattern string or a [pattern string, flags string] array (mandated by " + n + ")";
            break;
        case "exists":
            if (!u.isUndefined(t))
    ...
    var i = n(2)
      ...
      , c = n(26)
      , l = function(e, t, n) {
        if (e.getValueOrDefault)
            return e.getValueOrDefault(t, n);
        if (!i.isArray(t))
            return n;
        var r = u(e, t);
    ...
    t.booleanOperators = {
        ...
        regex: function(e) {
            try {
                var t, n;
                return i.isString(e[1]) ? (t = e[1],
                n = "i") : (t = e[1][0] || "",
                n = e[1][1] || ""),
                new RegExp(t,n).test(e[0])
            } catch (e) {
                return a.error("Rules", 'In operator "regex", error: ' + (e.message || "invalid RegExp /" + [t, n].join("/"))),
                !1
            }
        },
        exists: function(e) {
    ...
    t.aggregateOperators = {
        ...
        max: function(e, n) {
            for (var i = e[0] || t.DEFAULT_FIELD, r = Number.NEGATIVE_INFINITY, a = 0; a < n.length; a++)
                r = Math.max(r, l(n[a], i, Number.NEGATIVE_INFINITY));
            return r
        },
        min: function(e, n) {
            for (var i = e[0] || t.DEFAULT_FIELD, r = Number.POSITIVE_INFINITY, a = 0; a < n.length; a++)
    ...
    var f = {
      ...
      , p = function(e, t) {
        ...
        if (t.hasOwnProperty("eval"))
            return t["eval"]in f ? f[t["eval"]]() : void a.error("Rules", "Unknown function: " + t["eval"]);
        if (!t["op"])
            return void a.error("Rules", "No operator specified: " + c.stringify(t));
        var n = g(t["op"]);
        if (!n)
            return void a.error("Rules", "Unknown operator: " + t["op"]);
        var r = i.partial(p, e)
          , o = t["args"] || []
        ...
        for (var r = i.map(e, (function(e) {
            ...
            for (var o = t[a], s = [], u = {}, d = 0; d < r.length; d++) {
                var f = r[d]
                  ...
                  , p = f.join(".");
                u[p] = g,
                s.push(encodeURIComponent(p) + "=" + encodeURIComponent(c.stringify(g)))
            }
            var h = s.join("&");
    ...
    var v = function(e, n) {
        ...
        return i.each(n, (function(n, i) {
            ...
            for (var o = 0; o < e.length; o++) {
                ...
                if (u in t.aggregateOperators) {
                    ...
                    a.error("Rules", "Unknown aggregate operator " + u)
            }
        }
        )),
        r
      ...
      , m = function(e, t) {
        ...
        )) : (o("Rules", "groupBy rule must be an array"),
        t)
    };
    t.rewrite = function(e) {
        function n(e, s) {
            if (i.isArray(e) && ("and" !== e[0] && "or" !== e[0] && "not" !== e[0] && a.error("Rules", "Unexpected operation " + e[0] + ". Continuing optimistically."),
            e = {
                op: e[0],
                args: e.slice(1)
            }),
            e.hasOwnProperty("field") || e.hasOwnProperty("value") || e.hasOwnProperty("eval"))
                return e;
        ...
        var r = []
          , o = {}
          , s = {};
        e.hasOwnProperty(t.clause.WHERE) && (s[t.clause.WHERE] = n(e[t.clause.WHERE], !1)),
        e.hasOwnProperty(t.clause.HAVING) && (s[t.clause.HAVING] = n(e[t.clause.HAVING], !0)),
        (e.hasOwnProperty(t.clause.AGGREGATE) || r.length > 0) && (s[t.clause.AGGREGATE] = (e[t.clause.AGGREGATE] || []).concat(r));
        for (var u = [t.clause.GROUP_BY, t.clause.ORDER_BY, t.clause.SELECT, t.clause.OFFSET, t.clause.LIMIT], c = 0; c < u.length; c++)
            e.hasOwnProperty(u[c]) && (s[u[c]] = e[u[c]]);
        return e.hasOwnProperty(t.clause.FROM) && (s[t.clause.FROM] = t.rewrite(e[t.clause.FROM])),
        s
    }
    ;
    var E = function(e, n) {
        n = n || 0;
        var r = [];
        if (e.hasOwnProperty(t.clause.WHERE) ? e[t.clause.WHERE]["op"] ? e[t.clause.WHERE]["op"]in t.booleanOperators || r.push("Non-boolean WHERE clause operator") : r.push("Missing WHERE clause operator") : r.push("Missing WHERE clause"),
        e.hasOwnProperty(t.clause.HAVING) && (e[t.clause.HAVING]["op"] ? e[t.clause.HAVING]["op"]in t.booleanOperators || r.push("Non-boolean HAVING clause operator") : r.push("Missing HAVING clause operator")),
        e.hasOwnProperty(t.clause.GROUP_BY) && !e.hasOwnProperty(t.clause.AGGREGATE) && r.push("No AGGREGATE clause specified with GROUP_BY clause"),
        e.hasOwnProperty(t.clause.SELECT)) {
            var a = e[t.clause.SELECT];
            if (i.isArray(a))
                for (var o = 0; o < a.length; o++)
                    a[o]["op"] && a[o]["op"]in t.aggregateOperators && r.push('In SELECT clause, aggregate operator "' + a[o]["op"] + '" specified in selector at index ' + o);
            else
                r.push("SELECT clause must be an array")
        }
        ...
        e.hasOwnProperty(t.clause.FROM) && (r = r.concat(E(e[t.clause.FROM], n + 1))),
        r
    }
      , I = function(e, t) {
      ...
      , y = function(e, n) {
        var r = n;
        if (e.hasOwnProperty(t.clause.FROM) && (a.debug("Evaluating FROM clause:", e[t.clause.FROM]),
        ...
        e.hasOwnProperty(t.clause.AGGREGATE)) {
            ...
            r = _(o, s),
            a.debug("Results after AGGREGATE:", r)
        }
        e.hasOwnProperty(t.clause.HAVING) && (a.debug("Evaluating HAVING clause:", e[t.clause.HAVING]),
        r = i.filter(r, (function(n) {
            return p(n, e[t.clause.HAVING])
        }
        )),
        a.debug("Results after HAVING:", r)),
        e.hasOwnProperty(t.clause.ORDER_BY) && (a.debug("Evaluating ORDER_BY clause:", e[t.clause.ORDER_BY]),
        r = m(e[t.clause.ORDER_BY], r),
        a.debug("Results after ORDER_BY:", r));
        var u = 0;
        e.hasOwnProperty(t.clause.OFFSET) && (a.debug("Evaluating OFFSET clause:", e[t.clause.OFFSET]),
        u = Number(e[t.clause.OFFSET]));
        var c;
        return e.hasOwnProperty(t.clause.LIMIT) && (a.debug("Evaluating LIMIT clause:", e[t.clause.LIMIT]),
        c = u + Number(e[t.clause.LIMIT])),
        (u > 0 || !i.isUndefined(c)) && (r = r.slice(u, c),
        a.debug("Results after OFFSET/LIMIT:", r)),
        e.hasOwnProperty(t.clause.SELECT) && (a.debug("Evaluating SELECT clause:", e[t.clause.SELECT]),
    ...
    t.execute = function(e, n) {
        e = t.rewrite(e),
        a.shouldLog(r.LogLevel.DEBUG) && a.groupCollapsed("Evaluating Behavioral Rule"),
        a.debug("Rule:", e, c.stringify(e)),
        a.debug("Events:", n);
        var i = E(e);
        if (i.length > 0)
            throw new Error("Rule " + c.stringify(e) + " has violations: " + i.join("\n"));
        var o = y(e, n);
        return a.debug("Rule result:", o),
    ...
    t.isSatisfied = function(e, n) {
        try {
            ...
            return a.error("Rules", "Error " + t.toString() + " while evaluating rule " + c.stringify(e)),
            !1
        }
    }
}
    ...
    function i(e) {
        if (0 === e.length)
            return [];
        for (var t = e.length - 1, n = o.FIELDS.SESSION_ID, i = e[t][n]; t > 0 && i === e[t - 1][n]; )
            t--;
        return e.slice(t)
    }
    function r(e, t) {
        ...
        for (var i = e.length; i > 0 && n <= e[i - 1][o.FIELDS.TIME]; )
            i--;
        return e.slice(i)
    }
    var a = n(23)
    ...
    t.evaluate = function(e, n) {
        ...
        for (s = 0; s < e.length; s++) {
            ...
            try {
                var g = f;
                d.rule && (g = u.execute(d.rule, f)),
                o[d.id] = d.defaultValue,
                1 === g.length ? o[d.id] = g[0][0] || d.defaultValue : a.debug("Behavior / Rule for", d.id, "returned", g.length, "results, expected 1")
            } catch (e) {
    ...
    e.exports = function(e) {
        e.registerVisitorProfileProvider(n(160)),
        e.registerAudienceMatcher("first_session", n(161))
    }
}
), (function(e, t, n) {
    var i = n(62)
    ...
    function i(e, t) {
        ...
        if (1 !== n.length)
            throw new Error("Invalid query descriptor; verify that no aggregators are specified");
    ...
    function a(e, t) {
        if (!e)
            return ["Descriptor not defined"];
        var n = [];
        return e.count && n.push('Unexpected "count" clause specified'),
        e.pick && e.pick.modifier && t.indexOf(e.pick.modifier) === -1 && n.push('Invalid "pick" modifier "' + e.pick.modifier + '"'),
    ...
    function u(e, t) {
        ...
        return (t.pick || t.reduce && "count" === t.reduce.aggregator) && (a = c.flatten(a)),
        t.reduce && (a = a[0]),
        a
    }
    var c = n(2)
    ...
    e.exports = function(e) {
        e.registerDependency("sources/browser_id", n(165)),
        e.registerVisitorProfileProvider(n(170)),
        e.registerVisitorProfileProvider(n(171)),
        e.registerAudienceMatcher("browser_version", n(172))
    }
}
), (function(e, t, n) {
    var i = n(166);
    ...
    t.get = function() {
        var e = c.get();
        return i.isEmpty(e) && (e = r.parseUA(a.getUserAgent()),
        u.dispatch(o.SET_UA_DATA, {
            data: e
        })),
        e
    }
    ...
    var s = function(e, t, n) {
        if (a.includes(["mobile", "tablet"], e))
            return !0;
        if (a.includes(["opera mini"], t))
            return !0;
    ...
    !(function(r, a) {
        ...
        var o = "0.7.17"
                    ...
                    for (n = i = 0; n < f.length && !s; )
                        if (s = f[n++].exec(e))
                            for (r = 0; r < g.length; r++)
                                u = s[++i],
                                o = g[r],
                                typeof o === d && o.length > 0 ? 2 == o.length ? typeof o[1] == c ? this[o[0]] = o[1].call(this, u) : this[o[0]] = o[1] : 3 == o.length ? typeof o[1] !== c || o[1].exec && o[1].test ? this[o[0]] = u ? u.replace(o[1], o[2]) : a : this[o[0]] = u ? o[1].call(this, u, o[2]) : a : 4 == o.length && (this[o[0]] = u ? o[3].call(this, u.replace(o[1], o[2])) : a) : this[o] = u ? u : a;
                    l += 2
                }
            },
            str: function(e, t) {
          ...
          , N = function(e, t) {
            ...
            return this.getBrowser = function() {
                ...
                return R.rgx.call(e, n, i.browser),
                e.major = b.major(e.version),
                e
            }
            ,
            ...
            this.getDevice = function() {
                ...
                return R.rgx.call(e, n, i.device),
                e
            }
            ,
            this.getEngine = function() {
                ...
                return R.rgx.call(e, n, i.engine),
                e
            }
            ,
            this.getOS = function() {
        ...
        typeof t !== l ? (typeof e !== l && e.exports && (t = e.exports = N),
        t.UAParser = N) : "function" === c && n(169) ? (i = function() {
            return N
        }
        .call(t, n, t, e),
        !(i !== a && (e.exports = i))) : r && (r.UAParser = N)
    }
    ...
    e.exports = function(e) {
        e.registerVisitorProfileProvider(n(175)),
        e.registerAudienceMatcher("campaign", n(176))
    }
}
), (function(e, t, n) {
    var i = n(118);
        ...
        restorer: function(e) {
            return i.reduce(e, (function(e, t, n) {
                var r = t
                  ...
                  , u = s.getByApiName(n)
                  , c = s.getById(n);
                return i.isObject(t) && !t.id && (u && !c ? (o = u.id,
                r = {
                    id: u.segmentId || u.id,
                    value: t.value
                }) : c || a.warn("Unable to determine ID for custom attribute:", n, "; segmentation is disabled.")),
                e[o] = r,
                e
            }
            ), {})
    ...
    t.match = function(e, t) {
        var n;
        return e.custom && (n = e.custom[t.name]),
    ...
    e.exports = function(e) {
        e.registerDependency("sources/device", n(181)),
        e.registerVisitorProfileProvider(n(182)),
        e.registerAudienceMatcher("device", n(183))
    }
}
), (function(e, t, n) {
    var i = n(166);
    ...
    e.exports = function(e) {
        ...
        e.registerAudienceMatcher("device_type", n(186))
    }
}
), (function(e, t, n) {
    var i = n(166);
    ...
    e.exports = function(e) {
        e.registerVisitorProfileProvider(n(188)),
        e.registerAudienceMatcher("referrer", n(189))
    }
}
), (function(e, t, n) {
    var i = n(79)
    ...
    e.exports = function(e) {
        ...
        e.registerAudienceMatcher("source_type", n(194))
    }
}
), (function(e, t, n) {
    var i = n(118)
    ...
    e.exports = {
        ...
        getter: [function() {
            return function(e, t) {
                var n = function() {
                    if (i.getQueryParamValue("utm_source") || i.getQueryParamValue("gclid") || i.getQueryParamValue("otm_source"))
                        return "campaign";
    ...
    e.exports = function(e) {
        ...
        e.registerVisitorProfileProvider(n(197)),
        e.registerAudienceMatcher("time_and_day", n(198))
    }
}
), (function(e, t, n) {
    var i = n(24);
    ...
    function i(e) {
        var t = e.split(o);
        if (3 !== t.length)
            throw new Error("Invalid time and day string " + e);
        var n = t[2].split(s);
        return {
            start_time: t[0],
            end_time: t[1],
    ...
    function r(e) {
        var t = e.split(u);
        if (2 !== t.length)
            throw new Error("optly.timeAndDayInterval.timeStringToMinutes: Invalid time string " + e);
    ...
    function u(e) {
        if (null == e)
            throw new Error("Feature value is null");
        if ("object" == typeof e) {
            var t;
            try {
                t = x.stringify(e)
    ...
    function c(e) {
        if (null == e)
            throw new Error("Metric value is null");
        if (!N.isNumber(e))
            throw new Error("Metric value is not numeric")
    }
    function l(e) {
    ...
    function g(e) {
        ...
        Y.dispatch(V.REGISTER_PREVIOUS_BATCH, n),
        R()
    }
    function p(e) {
    ...
    function _() {
        if (!X.canSend())
            return void F.debug("Not sending events (holding)");
        var e = X.hasEventsToSend()
          , t = X.hasPreviousBatchesToSend();
        return e || t ? (t && (N.each(X.getPreviousBatches(), m),
        Y.dispatch(V.RESET_TRACKER_PREVIOUS_BATCHES)),
        void (e && (Y.dispatch(V.FINALIZE_BATCH_SNAPSHOT),
        m(X.getEventBatch()),
        Y.dispatch(V.RESET_TRACKER_EVENTS)))) : void F.debug("Not sending events because there are no events to send")
    }
    function m(e) {
    ...
    function T(e) {
        var t = N.reduce(e, (function(e, t) {
            var n;
            if (n = t.type !== J || !N.isEmpty(t.tags) || !N.isEmpty(N.pick(t, N.keys(ie))) || t.key && t.entity_id !== t.key ? t.uuid : t.type,
            e[n]) {
                var i = e[n].timestamp;
    ...
    function R() {
        function e() {
            var t = !re || j.isLoaded();
            t && _(),
            X.isPolling() && G.setTimeout(e, ne)
        }
        return X.shouldBatch() ? void (X.isPolling() || (G.setTimeout(e, ne),
    ...
    var N = n(2)
      ...
      , de = [function() {
        return function(e) {
            p(e),
            d(s(e), e.userFeatures, D(e.layerStates))
        }
    }
    ]
      , fe = [function() {
    ...
    e.exports = function(e) {
        ...
        H.on({
            ...
            handler: function() {
                Y.dispatch(V.SET_TRACKER_SEND_EVENTS, !0),
                X.isPolling() || _()
            }
        }),
        H.on({
    ...
    e.exports = function(e) {
        e.registerViewProvider(n(202)),
        e.registerViewMatcher("url", n(203))
    }
}
), (function(e, t, n) {
    var i = n(118);
    ...
    e.exports = function(e) {
        e.registerApiModule("recommender", n(205))
    }
}
), (function(e, t, n) {
    function i(e) {
    ...
    function a(e, t) {
        if (!i(t))
            return b in e ? I.parse(e[b]) : (y.warn('recommender / Expected key "' + b + '" not found'),
            []);
    ...
    function s(e, t) {
        var n = function(e, t, n) {
            if (!E.isArray(e) || E.isEmpty(e))
                throw new Error("No " + n + "s available");
            var i;
            if (t) {
                if (i = E.find(e, {
                    id: t
                ...
                !i)
                    throw new Error("No " + n + " found with specified id " + t)
            } else {
                if (e.length > 1)
                    throw new Error("No " + n + " id specified when there are more than one available.");
                i = e[0]
            }
            return i
        }
    ...
    function l(e, t, n, i) {
        ...
        return T.request({
            ...
            var n = []
              , o = u(t.response);
            return n = a(o, e.serviceVersion),
            s && r(e.serviceVersion) ? d(e, E.map(n, e.idTagName), i).then((function(e) {
    ...
    function d(e, t, n) {
        ...
        return E.isString(t) ? c(i, t) : S.all(E.map(t, (function(e) {
            return c(i, e)["catch"]((function(t) {
                return y.warn("recommender / Failed to get recommendations for item:", e, t),
                t
            }
            ))
        }
    ...
    function g(e, t, n) {
        var i = s(e, n)
          ...
          , o = i.recommender;
        if (!r(a.serviceVersion))
            throw new Error("Recommender service " + a.id + " serves self-contained recos. Use `fetchRecommendations` API call");
        return l(a, o, t, {
            overrideServingUrl: n && n.overrideServingUrl,
            fetchWithMetadata: !1
        })
    ...
    function v(e, t, n, i) {
        ...
        var r = s(e, t);
        this.recommenderService = r.recommenderService,
        this.recommender = r.recommender,
        this.targetId = n,
        i && (this.preFilter = i.preFilter,
        this.canonicalize = i.canonicalize,
        this.postFilter = i.postFilter),
        this._globalStore = e,
        this.reset()
    }
    function _() {
        ...
        return y.debug("recommender / fetching recommended items for", this.targetId, "from recommender", this.recommender.id),
        r(this.recommenderService.serviceVersion) ? g(this._globalStore, this.targetId, this.recommenderSettings).then(E.bind((function(t) {
            return e.recosNoMeta = E.filter(t, this.preFilter),
            e
        }
        ), this)) : f(this._globalStore, this.targetId, this.recommenderSettings).then(E.bind((function(t) {
            return e.recos = E(t).filter(this.preFilter).map(this.canonicalize).filter(this.postFilter).value(),
            e
        }
        ), this))
    }
    function m(e) {
        ...
        var u = e.recosSoFar;
        return y.debug("recommender / fetching metadata for", s, "from recommender", this.recommender.id),
        p(this._globalStore, s, this.recommenderSettings).then(E.bind((function(i) {
            ...
            return n.recosOffset = r.length,
            e.recosSoFar = u.concat(r),
            e.numNeeded -= r.length,
            e.numNeeded > 0 ? m.call(this, e) : e
        }
        ), this))
    }
    var E = n(2)
    ...
    v.prototype.next = function(e) {
        ...
        if (t <= 0)
            throw new Error("Invalid argument " + e + ". Must be positive integer");
        ...
        var n = this._bufferPromise.then(E.bind((function(e) {
            ...
            return i > 0 && (n = e.recos.slice(e.recosOffset, e.recosOffset + t),
            e.recosOffset += n.length,
            t -= n.length),
            t <= 0 ? {
                result: n,
                buffer: e
